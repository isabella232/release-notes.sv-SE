...
| ----------- | ---------- | ------- |
| Adobe Analytics-dokumentation | 11 november 2020 | Adobe Analytics dokumentation har flyttats till Experience League. Under november flyttades alla artiklar, videoklipp, versionsinformation och självstudiekurser från den aktuella platsen `docs.adobe.com` till `experienceleague.adobe.com`. Detta säkerställer att allt utbildningsmaterial, självhjälp, hjälpmedel och communityinnehåll hanteras från ett och samma ställe. Alla länkar omdirigerades till Experience League. |
