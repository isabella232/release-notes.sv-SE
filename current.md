...
| Google Ads och Microsoft Ads-kampanjer | I optimerade portföljer med alternativet &quot;Automatisk optimering av offertjusteringsvärden&quot; optimerar inte längre Advertising Cloud automatiskt inställningarna för anbudsjustering för kampanjer med den utökade offertstrategin (eCPC). Sökmotorn optimerar alla offertjusteringar vid tidpunkten för auktionen. Advertising Cloud optimerar fortfarande basanbuden och - när alternativet &quot;Justera kampanjbudgetgränser automatiskt&quot; är aktiverat - kampanjbudgeten. |
