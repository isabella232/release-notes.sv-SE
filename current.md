...
| **[!DNL Adobe Campaign]** (Klassisk och Standard) | Webbinarium | Semestersäsongen och årets livligaste tid för marknadsförare i olika kanaler ligger i centrum. Planeringen borde vara på gång. Detta [!DNL Adobe Campaign] Insider-sessioner behandlar ämnen som hjälper dig med e-postleverans, [!DNL Adobe Campaign] prestandaoptimering samt arbetsflöde och leveransmetoder för att säkerställa att instansen är i form för toppaktivitet.<p>**Datum:** 15 september kl. 8.00 PT [Detaljer och registrering](https://adobe-campaign-insider.dxfieldmarketing.adobeevents.com/) |
