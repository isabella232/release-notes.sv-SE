...
[Experience League LIVE](https://experienceleague.adobe.com/docs/experience-league-live-events/events/overview.html) är ett direktuppspelningsprogram som producerats av Experience League-teamet. Det är en chans att få kontakt med produktexperter från Adobe. Lär dig praktiska tips, tricks och strategier som du kan använda med Adobe Experience Cloud-programmen.
...
Läs [senaste versionsinformation](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html) for [!DNL Adobe System Status].
...
| ----------- | ---------- | ------- |
| Ej tillämpligt | | Se [Allmän tillgänglighet](https://experienceleague.adobe.com/docs/analytics/technotes/releases.html) |
...
| Januari 2022 | [Konfigurera trafikvariabler (props)](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/manage-report-suites/configuring-traffic-variables-props.html) | Video | Läs mer om konfiguration av trafikvariabler, som också kallas _proppar_ i Analytics Admin Console. |
...
* [Customer Journey Analytics produktdokumentation](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-landing.html)
...
* **Experience Manager as a Cloud Service**
   ...
   * **Cloud Manager**
      ...
      * Användare kan nu använda nya frontmatriser för att exklusivt distribuera slutkod snabbare. Se [Front End Pipelines för Cloud Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/introduction-ci-cd-pipelines.html#front-end) om du vill veta mer.
...
| Januari 2022 | [E-posttjänst](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/networking/examples/email-service.html) | Video | Skicka e-post från AEM as a Cloud Service genom att konfigurera AEM `DefaultMailService` för att använda avancerade nätverksportar. | AEM as a Cloud Service |
| Januari 2022 | [Grundläggande om Workfront förbättrade anslutningsmöjligheter](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/workfront/enhanced-connector/basics.html) | Video | Lär dig grunderna i Adobe Workfront och Experience Manager Assets förbättrade anslutningsprogram. Läs även om [Projektmappar](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/workfront/enhanced-connector/project-folders.html). | AEM Assets Service och Workfront |
...
| Januari 2022 | [Output Generation with XML Documentation for AEM](https://experienceleague.adobe.com/docs/experience-manager-xml-documentation-learn/videos/output-generation/overview.html) | Videor och artiklar | Läs mer om Map Dashboard, rapporter, publicering med baslinjer och villkor med mera. |
...
* Information om förhandsversioner av Adobe Target finns på [Adobe Target prerelease](https://experienceleague.adobe.com/docs/target/using/release-notes/target-release-notes.html) versionsinformation.
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Januari 2022 | [Förbättra din PDF](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/advanced-tasks/enhance.html) | Video | I den här praktiska självstudiekursen lär du dig hur du omformar PDF genom att lägga till grafikförbättringar och automatisk numrering. |
