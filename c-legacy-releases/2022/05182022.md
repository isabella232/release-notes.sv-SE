...
| Integrering med Adobe Analytics | (7 maj) I det dataflöde som Advertising Cloud skickar till [!DNL Analytics], data för [!DNL Google Ads] dynamiska sökannonser är bara tillgängliga på annonsgruppsnivå från och med den 7 maj 2022. |
