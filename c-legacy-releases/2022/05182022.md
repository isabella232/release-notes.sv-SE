...
| ------- | ----------- |
| Analyser för Advertising Cloud | Om din organisation vill byta från att använda den gamla Adobe Analytics `visitorAPI.js` till Adobe Experience Platform-biblioteket (`alloy.js`) för datainsamling måste du göra ändringar för att aktivera ID-sammanfogning. Se [Använda JavaScript-biblioteket för den senaste händelsetjänsten med Adobe Experience Platform Web SDK](https://experienceleague.adobe.com/docs/advertising-cloud/integrations/analytics/planning/web-sdk.html). |
