...
[Experience League event](https://experienceleague.adobe.com/events?lang=sv/) är en bra plats att lära sig, interagera och få svar från produktexperter på Adobe!
...
Se [Händelser](https://experienceleague.adobe.com/events?lang=sv/) på Experience League för att hålla sig uppdaterad.
...
* **Experience Manager Sites as a Cloud Service**
   ...
   * A [ny konsol](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/headless/content-fragments/content-fragment-console.html) optimerad för headless användning av innehållsfragment.
...
| Publicerad | Namn | Typ | Beskrivning | Program |
| -----------| ---------- | ---------- | ---------- | ------|
| Juni 2022 | [[!DNL Forms] Portalkomponenter](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/developing-for-cloud-service/forms-portal-components.html) | Video | Lär dig hur du aktiverar [!DNL AEM Forms] [!UICONTROL Portal] i Forms Cloud Service. | AEM Forms CS |
| Juni 2022 | [Integrera AEM- och CIF-ramverket för att skapa en omfattande och engagerande e-handelsupplevelse](https://experienceleague.adobe.com/docs/experience-manager-gems-events/gems/gems2022/aem-and-cif-framework-integration.html) | Video | Förstå hur Adobe CIF-ramverket kan användas för att skapa en enhetlig och innehållsrik och engagerande handelsupplevelse. | AEM och CIF-ramverket |
...
| Juni 2022 | [Context Aware Cloud-konfigurationer](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/developing-for-cloud-service/context-aware-fdm.html) | Video | Lär dig hur du definierar sammanhangsberoende molnkonfigurationer i AEM Forms i Cloud Service. | AEM Forms |
...
* Nytt [Kontrollpanelen i maj-utgåvan](https://experienceleague.adobe.com/docs/control-panel/using/release-notes.html#may-2022)
