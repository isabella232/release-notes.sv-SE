...
Adobe rekommenderar att du [uppgradera till den senaste 1.9.3-versionen](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/update-workfront-enhanced-connector.html) för Workfront för Experience Manager förbättrade kontakter.
