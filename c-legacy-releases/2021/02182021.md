...
* [Analyser](#analytics) **Uppdaterad 10 mars 2021**
...
Se [Adobe systemstatus - 21 maj 2020](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html?lang=en) för den senaste releaseinformationen.

## ![Ikon](/assets/ec_appicon_24.png) Experience Cloud och administration {#ecloud}

[Experience Cloud och administration](https://experienceleague.adobe.com/docs/core-services/interface/experience-cloud.html?lang=en) dokumentationen innehåller kundattribut, målgruppsbibliotek ([!UICONTROL People] tjänst), aktivering, användar- och produkthantering samt cookies från Experience Cloud.

**4 februari 2021**

* **Inloggningsuppdatering:** En uppdatering till Experience Cloud tar bort introduktionsskärmen för inloggning från Experience Cloud. Från och med 4 februari skickas du direkt från `https://experience.adobe.com/login` till inloggningsskärmen för Adobe.
...
* Ett problem med **[!UICONTROL Model]** klona i **[!UICONTROL Predictive Audiences]** -funktion. (AAM-56775)
...
* Ett problem där **[!UICONTROL Select all]** kryssruta i **[!UICONTROL Models > Exclude Traits]** kunde inte klickas för användare. (AAM-57366)
* Korrigerade ett problem i **[!UICONTROL Segment Builder]** där **[!UICONTROL Select all]** Om du markerar den här kryssrutan markeras inte alla egenskaper. (AAM-55640)
...
| 28 januari 2021 | [Skapa och hantera egenskaper](https://experienceleague.adobe.com/?recommended=AudienceManager-U-1-2020.3) | Kurs | Lär dig allt om att skapa och ordna egenskaper i produkten [!UICONTROL Trait Builder] till [!UICONTROL Bulk Management] verktyg. Lär dig även hur du använder [!UICONTROL Data Explorer] för att upptäcka viktiga signaler som kommer in i Audience Manager och skapa egenskaper för dem. |
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * **Headless Content Management Service**
         ...
         * [GraphQL API för leverans av innehållsfragment](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/graphql-api-content-fragments.html): Möjlighet att söka efter innehållsfragment med GraphQL-syntax och scheman baserade på Content Fragment-modeller, för utdata i JSON-format.
      ...
      * **Progressiva webbappar (PWA)**
         ...
         * [En progressiv webbprogramversion (PWA) av en webbplats](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/features/enable-pwa.html?lang=en) kan nu aktiveras på projektnivå via enkel konfiguration.
   * **Experience Manager Assets as a Cloud Service**
   ...
   * **Experience Manager Commerce as a Cloud Service**
      ...
      * **SDK Build Analyzers**
         ...
         Insticksprogrammet Experience Manager as a Cloud Service SDK Build Analyzer Maven identifierar problem i ett maven-projekt, inklusive saknade beroenden. Det ger utvecklare möjlighet att hitta problem under den lokala utvecklingen, långt före distributionen till molnmiljöer med Cloud Manager.
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| 11 februari 2021 | [Autentisering till AEM as a Cloud Service från ett externt program](https://experienceleague.adobe.com/?recommended=ExperienceManager-D-1-2020.1.aemcs) | Kurs | Lär dig hur ett externt program kan använda [!UICONTROL Local Development Access Tokens] och [!UICONTROL Service Credentials] att programmässigt autentisera till Experience Manager as a Cloud Service via HTTP. |
...
| 2 februari 2021 | [Vad är AEM Cloud Service?](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/what-is-aem-as-a-cloud-service.html) | Video | Se vad Experience Manager as a Cloud Service är och hur det skiljer sig från andra versioner av Adobe Experience Manager. |
| 2 februari 2021 | [Cloud Managers roll](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/cloud-manager.html) | Video | Utforska syftet med [!UICONTROL Cloud Manager] och hur det fungerar med Experience Manager as a Cloud Service. |
| 2 februari 2021 | [AEM as a Cloud Service utveckling](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/introduction/evolution.html) | Video | Undersök Experience Manager historia och skillnaderna mellan lokala Experience Manager, Adobe Managed Services AEM och Experience Manager as a Cloud Service. |
...
| 2 februari 2021 | [Content Publishing](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/basics/content-publishing.html) | Video | Se hur innehållspublicering på Experience Manager as a Cloud Service fungerar, inklusive koncept för innehållsdistribution och Adobe. |
...
| 28 januari 2021 | [Tokenbaserad autentisering till AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/authentication/overview.html?lang=en#authentication) | Video | Lär dig hur ett externt program kan autentisera och interagera med Experience Manager as a Cloud Service via HTTP med hjälp av åtkomsttoken. |
| 24 januari 2021 | [Skapa huvudformuläret som ska utlösa processen](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/sign-multiple-documents/create-initial-form.html) | Artikel | Det ursprungliga formuläret (ReFinance Form) används för att signera flera formulär genom att aktivera [!UICONTROL Sign Multiple Forms AEM] arbetsflöde. |
...
| 8 januari 2021 | [Massimport](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/bulk-import.html) | Video | Med verktyget för massimport på Experience Manager-as a Cloud Service kan administratörer importera resurser i bulk från molnlagring (Azure Blob Storage eller Amazon S3) på ett säkert och effektivt sätt. |
...
| Alla | I april kommer följande funktioner och vyer att bli inaktuella:<br><ul><li>Optimering > Portfolio-kort</li><li>Optimering > Anbudsregler</li><li>Insikter och rapporter > Kontrollpanel</li><li>Kampanjer: Väntande och schemalagt stöd för massredigeringar</li></ul> |
