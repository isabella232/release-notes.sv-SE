...
| November 2021 | [Använd SOAP API:er i arbetsflöden](https://experienceleague.adobe.com/docs/campaign-learn/use-soap-apis/introduction.html?lang=sv) | Videosjälvstudiekurser | Lär dig hur du använder Adobe Campaign Soap API:er och skapar ett avancerat leveransarbetsflöde baserat på data som tas emot via API:t. | Campaign V8 |
