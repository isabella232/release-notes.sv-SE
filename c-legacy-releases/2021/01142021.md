...
Experience Manager 6.5, Service Pack 7 (6.5.7.0 släppt 26 november 2020) är en viktig uppdatering som innehåller nya funktioner, viktiga kundförbättringar, förbättrade prestanda, stabilitet och säkerhet som släppts sedan den allmänna tillgängligheten för Experience Manager 6.5 april 2019.
...
Experience Manager 6.4, Service Pack 8, Cumulative Fix Pack 3 (6.4.8.3 släppt den 26 november 2020) är en viktig uppdatering som innehåller flera interna korrigeringar och kundkorrigeringar sedan den allmänna tillgängligheten för Experience Manager 6.4, Service Pack 8 (6.4.8.0), mars 2020.
...
Mer information om detta plugin-program finns i [Enhetlig upplevelse](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/refactoring-tools/unified-experience.html#benefits).
      * Indexkonverteraren är ett verktyg som kan användas för att omvandla en kunds anpassade OAK-indexdefinitioner till Experience Manager som en Cloud Service-kompatibel OAK-indexdefinitioner.
...
Se [AEM som en versionsinformation för Cloud Service.](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html?lang=en)
...
* **Best Practices Analyzer**
   ...
   * [!UICONTROL Cloud Readiness Analyzer] är nu  [!UICONTROL Best Practices Analyzer] (BPA). BPA ger en utvärdering av de effektivaste strategierna för din nuvarande implementering av Experience Manager och hjälper dig att utvärdera beredskapen att gå från en befintlig AEM till AEM som en [!UICONTROL Cloud Service].
...
* [AEM som Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html?lang=en)
...
| -----------| ---------- |
| Ny hjälp | (28 oktober) Den gamla hjälpen ersattes med uppdaterade sidor som är tillgängliga från hjälplänken på DSP huvudmeny och som också alltid är tillgängliga från [https://experienceleague.adobe.com/docs/advertising-cloud/dsp/home.html](https://experienceleague.adobe.com/docs/advertising-cloud/dsp/home.html) |
...
| Funktion | Beskrivning |
| -----------| ---------- |
| [!UICONTROL Search Campaigns] | I vyn [!UICONTROL Accounts] anger kolumnen [!UICONTROL Access] nu när [!DNL Advertising Search] inte kan logga in på ett aktiverat sökmotorkonto. Håll markören över varningsikonen om du vill se orsaken till felet. |
