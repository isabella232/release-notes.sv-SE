...
| -----------| ---------- | ---------- | ---------- |
| 23 december 2020 | [Översikt över unionens scheman](https://experienceleague.adobe.com/docs/platform-learn/tutorials/profiles/union-schemas-overview.html) | Video | Läs mer om fackliga scheman som används av Adobe Experience Platform kundprofil i realtid. |
