...
* Uppdaterat juli 2021 - [Versionsinformation för Journey Orchestration](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html)
...
Se [Versionsinformation om offer decisioning](https://experienceleague.adobe.com/docs/offer-decisioning/using/new/release-notes.html#new) för att hålla dig uppdaterad.
...
* **Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * Hämtningsfunktionen för länkdelning använder asynkrona nedladdningar som ökar nedladdningshastigheten. Se hjälpavsnittet [Hämta resurser som delas via länkdelning](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/download-assets-from-aem.html#link-share-download).
