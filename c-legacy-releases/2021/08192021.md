...
* [Händelsemeddelanden för Experience League Live](#events) - **26 augusti 2021**
...
Se [Versionsinformation för Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html) för mer information.
...
| -----------| ---------- | ---------- | ---------- |
| Augusti 2021 | [Aktivera profiler och segment till ett mål](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/activate-profiles-and-segments-to-a-destination.html?lang=en) | Video | Lär er hur marknadsförare kan aktivera målgruppssegment i realtid via CDP. Se hur du startar arbetsflödet i [!UICONTROL Destinations] eller [!UICONTROL Segments] gränssnitt, beroende på vad som passar dig bäst. |
| Augusti 2021 | [Konfigurera filbaserat molnlagringsutrymme eller e-postmarknadsföringsmål](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configuring-file-based-cloud-storage-or-email-marketing-destinations.html?lang=en) | Video | Få tips under genomgången av konfigurationen av ett filbaserat mål i Adobe Real-time Customer Data Platform (CDP). |
...
* Uppdaterat juli 2021 - [Versionsinformation för Journey Orchestration](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html?lang=en)
...
* **juliversion 2021:** Den nya [!UICONTROL Overview] hjälper dig steg för steg att komma igång med att skapa offertbeslut. Samma flik ger snabb åtkomst till de senaste erbjudandena, samlingarna och besluten.
...
* [Nya funktioner i Customer Journey Analytics](#cust-journey) (Uppdaterat **17 augusti 2021**)
...
| Augusti 2021 | [Treemap-visualisering](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/treemap-visualization.html?lang=en) | Video | Lär dig hur du lägger till och konfigurerar [!UICONTROL Treemap] visualisering i ditt Analysis Workspace-projekt. Den här visualiseringen kan hjälpa dig att visuellt analysera flera datapunkter samtidigt. |
| Augusti 2021 | [Förstå hur data kommer in i ditt Analysis Workspace-projekt](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/analysis-workspace-basics/understanding-how-data-gets-into-your-analysis-workspace-project.html?lang=en) | Video | Lär dig hur du ser dataflödet från sidan till tabellerna och visualiseringarna i Analysis Workspace med Adobe Experience Platform [!UICONTROL Debugger] i Chrome. |
| Augusti 2021 | [Visualisering av sammanfattningsnummer och sammanfattningsändringar](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/summary-number-and-summary-change-visualizations-2021.html?lang=en#) | Video | Lär dig hur du lägger till och konfigurerar [!UICONTROL Summary number] och [!UICONTROL Summary change] visualiseringar i Analysis Workspace. |
...
* Ett problem som rapporterats av kunder med [Masshanteringsverktyg](https://experienceleague.adobe.com/docs/audience-manager/user-guide/reference/bulk-management-tools/bulk-management-intro.html). Kunderna upplevde fel på grund av `traitAlias` när du uppdaterar mappningar mellan segment och mål. (AAM-58789)
* Ett problem som uppstod när åtkomst till en datafeed återkallades eller avbröts har åtgärdats. E-postmeddelandet som skickades till de borttagna användarna hade mottagarna i **Till** fält i stället för **Hemlig kopia**. (AAM-58512)
...
* **Experience Manager as a Cloud Service**
   ...
   Spela upp [Versionsöversikt juli 2021](https://video.tv.adobe.com/v/335580) video med en sammanfattning av tillagda funktioner.

   * **[!UICONTROL Cloud Acceleration Manager]**

      * [!UICONTROL Cloud Acceleration Manager] är en molnbaserad applikation som är utformad för att vägleda era IT-team under hela övergångsperioden, från planering till live Cloud Service. Konfigurera era team för en lyckad migrering med bästa praxis, tips, dokumentation och verktyg som rekommenderas av Adobe för att hjälpa till under varje fas av resan till Experience Manager as a Cloud Service. Se [Komma igång med Cloud Acceleration Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/moving/cloud-acceleration-manager/using-cam/getting-started-cam.html?lang=en).
      Spela upp [Cloud Acceleration Manager](https://video.tv.adobe.com/v/335547) demovideo.
   ...
   * **Experience Manager as a Cloud Service Foundation**
      ...
      * Trädreplikeringsgränssnittet under replikeringsagentens [!UICONTROL Distribute] tabben ska anses vara inaktuell. det planeras att tas bort efter den 30 september 2021. [Läs om alternativa replikeringsstrategier](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/operations/replication.html?lang=en#tree-activation).
      * Paket `org.apache.sling.datasource-1.0.4.jar` för stöd för Sling-datakällor har tagits bort eftersom funktionen är inaktuell och inte används av kunderna.
   ...
   * **Experience Manager Forms as a Cloud Service**
      ...
      * **[!UICONTROL Acroform-based Document of Record]** - Du kan också [använd Adobe Acrobat Form PDF (Acrobat PDF)](https://experienceleague.adobe.com/docs/experience-manager-forms-cloud-service/forms/create-an-adaptive-form/generate-document-of-record-for-non-xfa-based-adaptive-forms.html?lang=en) som en mall för postdokument förutom XFA-baserad formulärmall.
         **Microsoft® Azure-anslutning för datalager** - Nu kan du [ansluta formulärdatamodell till Microsoft® Azure Storage](https://experienceleague.adobe.com/docs/experience-manager-forms-cloud-service/forms/use-form-data-model/configure-azure-storage.html?lang=en). Med den kan du hämta och lagra adaptiva formulärdata i Microsoft® Azure Storage som en BLOB.
   * **[!UICONTROL Cloud Manager]**

      * Kunderna kan nu använda Azul 8 och 11 JDK för sina [!UICONTROL Cloud Manager] skapa processer. De kan antingen välja att använda en av dessa JDK:er för verktygskedjor-kompatibla Maven-pluginer eller hela Maven-processexekveringen.
      * IP-adressen för utgående utgång är nu loggad i loggfilen för byggsteget.
      * Scen- och produktionsmiljöer som kör tidigare versioner av Experience Manager rapporterar nu status för **Uppdatering tillgänglig**.
      ...
      * The **[!UICONTROL Manage Git]** har namnändrats till **[!UICONTROL Access Git Info]** och dialogrutan har uppdaterats visuellt.
...
| Augusti 2021 | [Översikt över pipeline - Demo Guide](https://video.tv.adobe.com/v/335668) | Video | Få en översikt över AEM as a Cloud Service [!UICONTROL Cloud Manager Pipeline]. |
