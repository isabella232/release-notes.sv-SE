...
>[!NOTE]
>
>Prenumerera på månadsvis [Produktuppdatering Adobe Priority](https://www.adobe.com/subscription/priority-product-update.html) om du vill få e-postmeddelanden om uppdateringar av den här sidan. Den här sidan underhålls hela månaden, så du bör regelbundet kontrollera om det finns uppdateringar av Adobe Enterprise-produkten och dokumentationen för Experience League.
...
Behöver du hjälp? Besök [Experience League](https://experienceleague.adobe.com/#home) för att hitta produktdokumentation och teknisk dokumentation, kurser på Adobe, videokurser, snabba svar, communityinsikter och lärarledd utbildning.
...
| Experience Cloud [!UICONTROL Triggers] navigering | [Experience Cloud-utlösare](https://experienceleague.adobe.com/docs/core-services/interface/services/triggers.html) är tillgängligt för direkt navigering från programväljaren i huvudet för tilldelade användare. |
...
Utgivningsdatum: **7 oktober 2021**
...
[!UICONTROL Offer Decisioning] är en integrerad tjänst med Adobe Experience Platform. Använd [!UICONTROL Offer Decisioning] för att leverera det bästa erbjudandet och upplevelsen till era kunder via alla kontaktytor vid rätt tidpunkt.
...
**Uppdatering 10/13/2021:** Kolla in [Versionsöversikt september 2021](https://video.tv.adobe.com/v/337381) en översikt över nya funktioner.
...
| Oktober 2021 | [Felsökning AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/moving-to-aem-as-a-cloud-service/troubleshooting.html) | Video | Lär dig hur du felsöker och felsöker AEM SDK, AEM as a Cloud Service och bygg- och distributionsprocessen. |
...
| Oktober 2021 | [[!UICONTROL Dispatcher]](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/moving-to-aem-as-a-cloud-service/dispatcher.html) | Video | Läs om AEM [!UICONTROL Dispatcher] för AEM as a Cloud Service, med fokus på betydande förändringar från [!UICONTROL Dispatcher] AEM 6 [!UICONTROL Dispatcher] konverteringsverktyget och hur du använder SDK för Dispatcher Tools. |
...
| Oktober 2021 | [AEM [!UICONTROL Modernization Tools]](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/moving-to-aem-as-a-cloud-service/aem-modernization-tools.html) | Video | Lär dig AEM [!UICONTROL Modernization Tools] används för att uppgradera ett befintligt AEM och innehåll som är AEM as a Cloud Service kompatibelt. |
| Oktober 2021 | [AEM Modernization Tools](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/moving-to-aem-as-a-cloud-service/introduction.html) | Video | Lär dig att tänka annorlunda när det gäller AEM as a Cloud Service implementeringar. |
...
| Oktober 2021 | [Bevara versionshistorik](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/workfront/versions.html) | Video | Läs om Adobe Workfront och Experience Manager [!UICONTROL Assets Essentials] hjälper dig att underhålla versioner av [!DNL Workfront] dokument och Assets Essentials. |
| Oktober 2021 | [Skicka dokument och länka resurser](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/workfront/link-send.html) | Video | Lär dig hur du skickar Workfront-dokument till Assets Essentials och länkar Assets Essentials till Workfront. |
...
| Oktober 2021 | [Segment Builder i Adobe Analytics](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/segment-builder-overview.html#) | Video | Segmentera och minska era data med segmentering i Adobe Analytics. I den här videon får du hjälp med [!UICONTROL Segment Builder] och ger en grundläggande översikt. |
...
### Nytt [!UICONTROL Campaign] kurser och självstudier {#tutorials-campaign}
...
Se [[!DNL Target] versionsinformation](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html) för den senaste releaseinformationen.
