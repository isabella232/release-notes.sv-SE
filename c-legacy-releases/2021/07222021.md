...
Se [Versionsinformation om offer decisioning](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html?lang=en) för att hålla dig uppdaterad.

**Fler resurser för Offer decisioning**

[Dokumentation](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioniong/get-started/starting-offer-decisioning.html?lang=en) – [Versionsinformation](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html?lang=en) – [Instruktionsvideor](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/decision-management/introduction-to-decision-management.html?lang=en)
...
* **Experience Manager as a Cloud Service**
   ...
   * **as a Cloud Service stödlinjer för Experience Manager**
      ...
      * **Ny stil och känsla för webbredigeraren** - Nytt utseende och ny känsla med gränssnittsändringar som gör det mer intuitivt. Den underliggande arkitekturen har ändrats från korall till reaktionsbaserad spektrum.
      ...
      Besök [Stödlinjer för Experience Manager](https://business.adobe.com/products/experience-manager/guides/aem-guides.html) för mer information.
   ...
   * **Cloud Manager i AEM as a Cloud Service**
      ...
      * På sidan med miljöinformation visas nu flera domännamn för tjänsterna Publicera och Förhandsgranska, beroende på vad som är tillämpligt. Se [Miljöinformation](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-environments.html?lang=en).
   * **Experience Manager Assets as a Cloud Service**
      ...
      * The [Verktyget Massinhämtning](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/add-assets.html?lang=en) gör att du kan lägga till metadata vid ett gruppinhämtning.
      ...
      * The [!UICONTROL Link Share] nedladdningsfunktionen använder asynkrona nedladdningar som ökar nedladdningshastigheten. Se [Hämta resurser som delas via länkdelning](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/download-assets-from-aem.html?lang=en).
...
* [as a Cloud Service versionsinformation för Experience Manager](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current.html?lang=en)
...
* [Versionsinformation för Campaign v8](https://experienceleague.adobe.com/docs/campaign/campaign-v8/new/whats-new.html?lang=en)
...
| Juli 2021 | [Recensioner och godkännanden med Adobe Document Services API:er](https://experienceleague.adobe.com/docs/acrobat-services-learn/tutorials/usecases/reviews.html?lang=en) | Artikel | Lär dig hur du löser problem med manuell granskning och godkännande med hjälp av flera Adobe Document Services API:er. |
