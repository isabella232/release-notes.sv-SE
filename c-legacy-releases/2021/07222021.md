...
Den senaste versionsinformationen om systemstatus för Adobe finns i [21 maj 2020](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html) versionsinformation.
...
* **Juli 2021:** Journey Optimizer finns nu att köpa. [Läs mer](https://experienceleague.adobe.com/docs/journey-optimizer/using/ajo-home.html).
...
Se [Versionsinformation om offer decisioning](https://experienceleague.adobe.com/docs/journey-optimizer/using/whats-new/release-notes.html) för att hålla dig uppdaterad.
...
* **Experience Manager as a Cloud Service**
   ...
   * **Cloud Manager i AEM as a Cloud Service**
      ...
      * En ny regel för kodkvalitet har lagts till för att validera strukturen för `damAssetLucene`index. Se [Anpassade index för DAM-tillgångar, Luceneak](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/custom-code-quality-rules.html).
      * På sidan med miljöinformation visas nu flera domännamn för tjänsterna Publicera och Förhandsgranska, beroende på vad som är tillämpligt. Se [Miljöinformation](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/manage-environments.html).
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * The [Verktyget Massinhämtning](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/add-assets.html) gör att du kan lägga till metadata vid ett gruppinhämtning.
      ...
      * The [!UICONTROL Link Share] nedladdningsfunktionen använder asynkrona nedladdningar som ökar nedladdningshastigheten. Se [Hämta resurser som delas via länkdelning](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/download-assets-from-aem.html).
...
* [Versionsinformation för Campaign v8](https://experienceleague.adobe.com/docs/campaign/campaign-v8/new/whats-new.html)
