...
>[!NOTE]
>
>Prenumerera på den månatliga [produktuppdateringen Adobe Priority](https://www.adobe.com/subscription/priority-product-update.html) för att få e-postmeddelanden om uppdateringar av den här sidan. Den här sidan bevaras under hela månaden och kan innehålla innehåll som kan ändras före ett publiceringsdatum. Kontrollera regelbundet om det finns uppdateringar av Adobe Enterprise-produkten och dokumentationen för Experience League.
...
De senaste uppdateringarna av systemstatusen för Adobe finns på [Adobe systemstatus - 21 maj 2020](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html?lang=en).
...
Version från februari 2021 - Läs mer om de senaste funktionerna, förbättringarna och korrigeringarna i [versionsinformationen för Journey Orchestration](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html?lang=en).
...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * Experience Manager Assets som Cloud Service har rätt att ha en förkonfigurerad Brand Portal-instans. Cloud Manager-användaren kan aktivera Brand Portal på Experience Manager Assets som en Cloud Service. Se [Aktivera Brand Portal med Brand Portal](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/brand-portal/configure-aem-assets-with-brand-portal.html).
...
* **Adobe Summit 2021 | Fullständig sessionslista för Experience Manager**
   ...
   [Här ](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/adobe-summit-2021-complete-aem-session-list/td-p/398344) finns en sammanställd förteckning över alla sessioner i Experience Manager som ägde rum i  **Adobe Summit 2021**.
...
* [Experience Manager som Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html?lang=en)
...
* [Användarhandbok för Cloud Manager](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-manager/using/introduction-to-cloud-manager.html)
* [Äldre versioner av Experience Manager-dokumentation](https://experienceleague.corp.adobe.com/docs/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions.html)
...
* [Versionsinformation](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html?lang=en) för Campaign Classic.
...
| [!UICONTROL Search Campaigns]<br> [!UICONTROL Bulksheets] | (Microsoft® Advertising-kampanjer) För expanderade textannonser finns nu stöd för en tredje rubrik ([!UICONTROL Ad Title 3]) som tillval och en andra beskrivning ([!UICONTROL Description 2]) som tillval. Stöd finns i vyn [!UICONTROL Ads] och i [!UICONTROL Bulksheets]. |
