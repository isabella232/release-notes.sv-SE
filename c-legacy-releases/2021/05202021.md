...
De senaste uppdateringarna av Adobe systemstatus finns på [Adobe systemstatus - 21 maj 2020](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html) för den senaste releaseinformationen.
...
Läs mer om de senaste funktionerna, förbättringarna och korrigeringarna i [Versionsinformation för Journey Orchestration](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html).
...
Mars 2021-utgåvan - Läs mer om de senaste funktionerna i [Versionsinformation om offer decisioning](https://experienceleague.adobe.com/docs/offer-decisioning/using/new/release-notes.html#new).
...
* Tillagd [DCS-systemfelkod 10](https://experienceleague.adobe.com/docs/audience-manager/user-guide/api-and-sdk-code/dcs/dcs-api-reference/dcs-error-codes.html#system-error-codes), vilket anger om egenskaperna på begäran antingen har utvärderats delvis eller inte har utvärderats alls.
...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * **Adobe Experience Manager as a Cloud Service Foundation**
      ...
      * [Publicera arbetsflöde för innehållsträd](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/operations/replication.html#publish-content-tree-workflow) - En ny arbetsflödesmodell och ett nytt steg ger bättre prestanda vid publicering av djupa innehållshierarkier.
   ...
   * **Experience Manager Assets as a Cloud Service**
      ...
      * Administratörer kan konfigurera Experience Manager att ta bort resurskällan efter att ha gjort en massmedieinmatning. Se [massmaterialinmatning](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/add-assets.html#asset-bulk-ingestor).
      * När du utför en hälsokontroll för att importera resurser i grupp ger Experience Manager nu fler orsaker till misslyckanden. Se [massmaterialinmatning](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/add-assets.html#asset-bulk-ingestor).
      * När du importerar resurser med bulkimportverktyget kan administratörer nu välja att ta bort källfilerna när importen är klar. Se [massmaterialinmatning](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/add-assets.html#asset-bulk-ingestor).
...
* [Handböcker om Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html)
...
Se [!DNL Marketo Engage] [versionsinformation](https://experienceleague.adobe.com/docs/marketo/using/release-notes/release-schedule.html) för information om senaste releaseschemat.
...
Se [Creative Cloud för Enterprise Tutorials](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/overview.html) för de senaste självstudiekurserna.
