...
* [Versionsinformation om Campaign Classic ](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html?lang=en)
...
| -----------| ---------- |
| Paketinställningar | En ny [!UICONTROL Pacing Fill Strategy] option, &quot;[!UICONTROL Slightly Ahead],&quot; är tillgängligt och är standard för nya paket. Den här strategin snabbar upp leveransen så att den är 55-65 % färdig halvvägs genom flygningens längd. |
