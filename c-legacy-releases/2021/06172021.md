...
* Uppdaterad i april 2021 - [Versionsinformation om offer decisioning](https://experienceleague.adobe.com/docs/offer-decisioning/using/new/release-notes.html?lang=en#new)
...
* Frisläppt en förbättring av [Aktivitetsanvändningsrapport](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/administration/activity-usage-reporting.html?lang=en) som nu gör det möjligt att granska data som är äldre än ett år. (AAM-58268)
...
* **Experience Manager as a Cloud Service**
   ...
   * **Adobe Experience Manager as a Cloud Service Foundation**
      ...
      * [Förhandsversion - kanal](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/prerelease.html?lang=en): Förgranska kommande funktioner en månad innan de publiceras live!
...
| Publicerad | Namn | Typ | Beskrivning |
| -----------| ---------- | ---------- | ---------- |
| Juni 2021 | [Implementera gränssnittsmetoderna](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/doc-cloud-sdk/implement-interface.html?lang=en) | Artikel | Lär dig hur du implementerar gränssnittsmetoder för att skapa PDF med Document Cloud REST API. |
...
| Juni 2021 | [Skapa anpassat processsteg](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/forms/doc-cloud-sdk/custom-process-step.html?lang=en) | Artikel | Visa den fullständiga koden för det anpassade processsteget som konverterar och ersätter originalfilerna med det konverterade PDF. Det här anpassade steget söker efter alla bilagor under mappnamnet, som anges som ett processargument i arbetsflödet. Det här anpassade processsteget använder metoderna i det anpassade `DocumentCloudSDKService` för att skapa PDF. |
...
* **Adobe Campaign Classic version 7.1.3:** Läs mer i [Versionsinformation om Campaign Classic v7](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html?lang=en).

* **Adobe Campaign Standard 21.2:** Läs mer i [Versionsinformation om Campaign Standard](https://experienceleague.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html?lang=en).
