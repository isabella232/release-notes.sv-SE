...
<!-- <draft-comment> 
    ...
    </draft-comment> --> <p> <b>Se även:</b> ID-tjänst <a href="../../c-legacy-releases/2017/08172017.md#mcvid" format="dita" scope="local"> för Marketing Cloud </a> (tidigare <span class="term"> besökar-ID-tjänst </span>) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Datalager </p> </td> 
   <td colname="col2"> <p> 
     <ul id="ul_41A7B52EFE5A4A2CBBEDC38389E17E13"> 
      <li id="li_89D4145EE47A4C49A209C9DEFA7C3811"> Korrigerade ett fel som orsakade att datalagrets timjobb skapades för fel timma runt sommarövergångar (AN-140128) </li> 
...
* [Avlyssningsregler](https://marketing.adobe.com/resources/help/en_US/social/c_settings_rules.html): Reglerna blir automatiskt inaktiva efter sex månader. Regler som har upphört att gälla finns på fliken [!UICONTROL  Inaktiv] i [!UICONTROL  regelbyggaren] och kan förnyas i 6 månader var för sig eller gruppvis.
...
### Versionsinformation för AEM {#section_A26CA0B1CC014A59A59EE6406C61771C}
