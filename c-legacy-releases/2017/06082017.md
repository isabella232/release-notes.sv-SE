  ...
  <tr> 
   ...
   <td colname="col2"> <p>I version 4.13.6 gjordes följande SDK-förbättringar i iOS och Android: </p> 
    <ul id="ul_B4DC25FD25B745A6BB39B8965D22ECAD"> 
     <li id="li_17282AB9A66A4484917CB9B703AA6DE8">I Marketing Cloud ID-tjänsten kan du nu skriva över ett befintligt värde för ett ID med API: <span class="varname"> n för </span> syncIdentifiers. </li> 
...
* I iOS 10.3 är det ett problem där Marketing Links visar en tom sida efter att användaren har klickat **[!UICONTROL  Cancel]** . (MOB-7380)
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Analytics har introducerat tre nya produkter: </p> 
    <ul id="ul_F617128BEA66444EB65DA29787BF19FE"> 
     <li id="li_3854FD42B52746638740897C52200A1D"> <a href="https://www.adobe.com/se/data-analytics-cloud/analytics/ultimate.html" format="html" scope="external"> Ultimate </a> </li> 
     <li id="li_41F95B75A97843A5B47B3F175310EF18"> <a href="https://www.adobe.com/se/data-analytics-cloud/analytics/prime.html" format="html" scope="external"> Prime </a> </li> 
     <li id="li_DB474BBAFBE145D2BD118194A8D867FE"> <a href="https://www.adobe.com/se/data-analytics-cloud/analytics/select.html" format="html" scope="external"> Välj </a> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_54675DB3F59E4B24AF0C8F6E6AB2F3C1"> 
     <li id="li_DEF7D9BF03CD4A2D86A4BDD89FB3731A">En ny visualiseringsinställning med namnet <span class="term">Inaktivera etikettförkortning</span> (standard = avmarkerad) har lagts till. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   ...
   <td colname="col2"> <p>Ändringar av kalendern så att den överensstämmer med kalendern för rapporter och analyser: </p> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Förbättrad sökning efter måttobjekt </p> </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_7B6B794EDF874A4D87770AB9BAB42F33"> 
     <li id="li_0B403D892320434FBAD9A7F7B808947C"> <p> En kryssruta för att ange gränser för procent har lagts till, avsedd särskilt för procentbaserade mätvärden (fungerar även med icke-procentbaserade mätvärden). </p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p> Förbättringar av <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/alert-manager.html" format="html" scope="external">Aviseringshanteraren</a>  </p> </td> 
   <td colname="col2"> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Nya <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/fa_shortcut_keys.html" format="html" scope="external">kortkommandon</a></p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Microsoft Power BI är en serie kontrollpaneler för affärsanalys som används för att analysera data och dela insikter. Adobe Analytics-integreringen med Power BI innefattar möjligheten att visualisera Report Builder Analytics-data i Microsoft Power BI. </p> <p>Med Power BI kan ni integrera Adobe Analytics med andra datakällor (t.ex. försäljningsplats, CRM) för att identifiera unika kundinsikter, associationer och möjligheter och enkelt dela dem i hela organisationen. Genom att kombinera rapportgenereringsfunktionen i Report Builder med Power BI blir informationen mer webbtillgänglig för alla i organisationen. </p> <p>Tack vare integreringen med Adobe Report Builder kan du </p> 
    <ul id="ul_48CC72D3E88B4CCAB6762A32E68E5764"> 
     <li id="li_AC7B3FF2796442A8B7269BEB0824831C"> Publicera schemalagda Report Builder-arbetsböcker på Power BI. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Före den 20 april 2017 var alla användare (inklusive administratörer) tvungna att genomgå en tentamen och beviljas tillstånd att använda bearbetningsreglerna av Adobe Customer Care. </p> <p>Administratörer har för närvarande behörighet att använda bearbetningsregler som standard. Tentamen behövs inte längre. Administratörer kan även ge dessa rättigheter till icke-administratörer via gränssnittet Administratörsverktyg. <a href="https://marketing.adobe.com/resources/help/en_US/reference/processing_rules.html" format="html" scope="external"> Mer.. </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_DAB0360A2EB74CE7B7D9D20D19C3F6AE"> 
     <li id="li_CD2EE3675FD045A2B1A2BD960C0F7F2A">Ett problem med att Ad Hoc Analysis och Analysis Workspace rapporterade felaktiga data för Target Activity har korrigerats. (AN-141435) </li> 
     ...
     <li id="li_B64C547F580041AFBF081AFF40C58BCF">Korrigerade ett problem som orsakade ett fel när segment skapades när"Gör det här till en Marketing Cloud-målgrupp" kontrollerades. (AN-142218, AN-143300) </li> 
     ...
     <li id="li_C06F93EF77314A8D9F04BF4077A996D1">Ett problem har korrigerats där användargruppnamnen inte var i alfabetisk ordning i Admin Console. (AN-142769, AN-142274) </li> 
     <li id="li_74750379709445DC97F22CC212C80E21">Korrigerade ett Admin Console-problem som hindrade Ad Hoc Analysis från att aktiveras eller inaktiveras för en rapportserie. (AN-142529) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_3CA7C4AA4AE843719A755ECE64EE91B6"> 
      ...
      <li id="li_1A05EC9B86AD4D9BA09340BB64729864"> Korrigerade ett fel som uppstod när mätningssynligheten konfigurerades, men inte den metriska polariteten. Den resulterande färgen för Sammanfattningsändring i Analysis Workspace var inte som förväntat (rött om negativt, grönt om positivt). (AN-143496, AN-143413) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7C375006CB8A4723B3FC07A8FF7FF6E6"> 
      <li id="li_C8B5B5AE90964673BBE3AC8271F6A2EA">Ett problem som gjorde att ett gammalt rapportsvitnamn visades i Report Builder har korrigerats, även om namnet hade ändrats i administratörsverktygen (AN-139276) </li> 
      <li id="li_BC279F05086144CE8BE0A9A60C5FE865">Ett problem som gjorde att inloggningen till Report Builder inte kunde användas för inloggning med enkel inloggning i Marketing Cloud har korrigerats. (AN-138557) </li> 
      <li id="li_310B2FCF1091411BA9983E8FC1BF8714">Ett problem som orsakade att en blandning av språk visades i Report Builder-gränssnittet har åtgärdats. (AN-137183) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_336B914674184FF9AC9602E0448FEFC0"> 
      <li id="li_6BB458583BE249189EDF2DC6480F75BA">Ett problem som gjorde att Activity Map inte lästes in korrekt efter inloggningen har åtgärdats. (AN-139709) </li> 
...
<table id="table_BFC1B2ABAC8C41B69A7AE72B1BF191DA"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Uppdaterat till LinkedIn API version 2.0 för organisationer. Detta kommer inte att påverka funktioner, men <span class="keyword"> Adobe Social </span>uppdateras med de senaste API:erna. 
     <!--AS-39691--></p> </td> 
  </tr> 
 </tbody> 
</table>
...
* En varning har lagts till i [!UICONTROL  Publisher] att förhandsgranskningen är en uppskattning och kanske inte matchar den mobila leveransen.
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>AEM datorprogram 1.5 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> AEM 6.1 SP2-CFP9, släppt 5 juni 2017, är en viktig uppdatering som innehåller viktiga kundkorrigeringar som släppts sedan den allmänna tillgängligheten av AEM 6.1 SP2 i augusti 2016. </p> <p> 
     <ul id="ul_500BCBB0899D4F77B3D2A72F121F4A1B"> 
      ...
      <li id="li_08A790CB5D4740E4B522D59A70174204"> <a href="https://helpx.adobe.com/se/aem-forms/kb/aem-forms-releases.html" format="https" scope="external"> AEM 6.1 Forms </a> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p> AEM 6.2 SP1-CFP4, släppt 7 juni 2017, är en viktig uppdatering som innehåller viktiga kundkorrigeringar som släppts sedan den allmänna tillgängligheten av AEM 6.2 SP1 i december 2016. </p> <p> 
     <ul id="ul_3968AE5D0CE04EC98CC5E212727F23DE"> 
      ...
      <li id="li_255BB17A0507445B890E52DC04DD0150"> <p> <a href="https://helpx.adobe.com/se/aem-forms/kb/aem-forms-releases.html" format="https" scope="external"> AEM 6.2 Forms </a> </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="1"> <p> <b>Självhjälp</b> </p> </td> 
   <td colname="col2"> <p>Felsökningsguide för AEM datorprogram </p> </td> 
   <td colname="col3"> <p> <a href="https://helpx.adobe.com/experience-manager/kb/troubleshooting-companion-app.html" format="https" scope="external"> Felsökningsguide för AEM datorprogram </a> uppdaterad för att återspegla förändringar i arkitekturen i de senaste versionerna. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p>Referensmaterial finns <a href="https://docs.adobe.com/docs/en/aem/6-3/develop/ref.html" format="https" scope="external"> tillgängligt, </a> inklusive följande resurser: </p> <p> 
     ...
     </ul> </p> <p> <a href="https://docs.adobe.com/docs/en/htl.html" format="https" scope="external"> Förbättringar av HTML-mallspråk </a> som bygger på AEM 6.3-funktioner. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="1"> <p> <b>Community</b> </p> </td> 
   <td colname="col2"> <p>IMMERSE17 on-demand </p> </td> 
   <td colname="col3"> <p>Det finns biljetter för IMMERSE17 on-demand-sessioner. Köp <a href="https://vts.inxpo.com/Launch/QReg.htm?ShowKey=35334" format="https" scope="external"> här </a> och använd <code>OD#1AEM</code> kod. </p> <p>Tillgängliga sessioner: </p> <p> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Advertising Cloud användarforum har bytt namn till Advertising Cloud användarforum och finns på <a href="https://forums.adobe.com/community/experience-cloud/advertising-cloud/overview" format="https" scope="external"> https://forums.adobe.com/community/experience-cloud/advertising-cloud/overview </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nu kan du testa hur Google Customer Matching-målgrupper skapas och uppdateras med hjälp av e-postlistor från ditt eget CRM-system. Kontakta din kontoansvarige på Advertising Cloud om du vill ha mer information. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Endast Beta-tillåtslista annonsörer) Nya funktioner: </p> <p> 
