  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_DE987D7BAD144978AD6D163DD5C6C4FB"> 
      ...
      <li id="li_C6453E36AF3140829CD6D665DD4D1F1D">Ett problem som orsakade det här problemet har korrigerats: När du skapade en ny rapportserie med en mall kopierades klassificeringarna First/Last Touch till den nya rapportsviten, var klassificeringsschemat synligt, men klassificeringsrapporterna var inte synliga på menyn Rapporter och analyser. (AN-144068) </li> 
...
<!-- <draft-comment> 
    ...
    </ul> <p> <b>Se även:</b> ID-tjänst <a href="../../c-legacy-releases/2017/07202017.md#mcvid" format="dita" scope="local"> för Marketing Cloud </a> (tidigare <span class="term"> besökar-ID-tjänst </span>) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Förbättringar av [!UICONTROL  profilkopplingsregler]: Alla enheter som kvalificerar sig för ett segment i realtid med en profilkopplingsregel som skapats med alternativet för enhetsdiagram (t.ex. Adobe Co-op Device Graph eller ett externt enhetsdiagram) kommer nu att ingå i segmentets totala populationsantal. Dessutom skickas ID:n för dessa kvalificerade enheter också till alla batchmål som konfigurerats för det segmentet. Se Vanliga frågor om [regler för profilsammanfogning och Vanliga frågor](https://marketing.adobe.com/resources/help/en_US/aam/profile-merge-faq.html) om enhetsdiagram samt [egenskaper och segmentpopulationsdata i segmentbyggaren](https://marketing.adobe.com/resources/help/en_US/aam/segment-builder-data.html). (AAM-27726)
* CSV-filer för [!UICONTROL  överlappningsrapporter] omslutna strängdata med dubbla citattecken. Se [CSV-filer för överlappningsrapporter](https://marketing.adobe.com/resources/help/en_US/aam/overlap-csv-files.html).
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Beta endast för godkända annonsörer) Bland de nya funktionerna finns följande: </p> <p> 
