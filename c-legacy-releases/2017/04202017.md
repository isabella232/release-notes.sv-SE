...
<!-- <draft-comment> 
    ...
    </draft-comment> --> <p> <b>Se även:</b> <a href="../../c-legacy-releases/2017/04202017.md#mcvid" format="dita" scope="local"> ID-tjänst för Marketing Cloud </a> (tidigare <span class="term"> besökar-ID-tjänst </span>) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>(Endast tillåtna betaversioner) Ett nytt användargränssnitt för Search Beta kommer att vara tillgängligt veckan efter releasen, med: </p> <p> 
