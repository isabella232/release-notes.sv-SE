...
>[!IMPORTANT]
>
>Launch lanseras stegvis för Adobe Experience Cloud-kunder. Om du vill ha snabb åtkomst skickar du informationen till oss genom att ange[den i startformuläret](https://adobe.allegiancetech.com/cgi-bin/qwebcorporate.dll?WVFJ3K).
...
Launch erbjuds Adobe Experience Cloud-kunder som en inkluderad funktion som ger mervärde. Launch är en helt ny produkt med en ny kodbas som är utformad för att ersätta den tidigare tjänsten Dynamic Tag Management (DTM). DTM kommer dock att fortsätta att stödjas inom överskådlig framtid. Adobe kommer att fortsätta att åtgärda eventuella allvarliga fel och säkerställa enhetliga prestanda. För närvarande planeras inga större funktionsförbättringar för äldre DTM.
...
<table id="table_579DC25A4F3A49A78290837578B12D96"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Taggen Launch container är 60 % ljusare än Adobe Tag Manager och 40 % ljusare än Google Tag Manager. Innehållet i behållaren är minifierat, inklusive din egen kod. Allt är modulärt. Om du inte behöver något objekt inkluderas det inte i ditt bibliotek. Resultatet är en snabb och kompakt implementering. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Från och med mars 2018 måste Adobe ID logga in eftersom inloggningsprocessen för Adobe Analytics inte längre stöds. [Mer...](https://marketing.adobe.com/resources/help/en_US/mobile/gs_signin.html).
...
<!-- <draft-comment> 
    ...
    </draft-comment> --> <p> <b>Se även:</b> <a href="../../c-legacy-releases/2017/11092017.md#mcvid" format="dita" scope="local"> Marketing Cloud ID-tjänst </a> (tidigare <span class="term"> besökar-ID-tjänst </span>) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Ett fel som gjorde att API-metoden för segmentmappens GET inte kunde returnera ` path` -parametern har åtgärdats.
* Korrigerade ett fel som förhindrade att parametern i API-metoden för GET returnerade det totala antalet undermappar. ` folderCount`
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Det här funktionspaketet innehåller uppdateringar av innehållsfragment, kärnkomponenter och JSON-exporteraren. </p> <p>Förbättringarna gör det möjligt att definiera innehållsfragment som baseras på strukturerade innehållsmodeller och att leverera AEM innehåll i JSON-format för användning i olika kanaler och via kontaktpunkter. </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>AEM 6.3 Service Pack 1 (6.3.1.0), släppt 13 oktober 2017, är en viktig uppdatering som omfattar prestanda, stabilitet, säkerhet och viktiga kundkorrigeringar och förbättringar som släppts sedan den allmänna tillgängligheten av AEM 6.3 i april 2017. </p> <p>Du kan installera AEM 6.3 Service Pack 1 på AEM 6.3 GA. </p> <p>Viktigaste nyheterna i detta Service Pack är följande: </p> <p> 
     ...
     </ul> </p> <p> <a href="https://helpx.adobe.com/experience-manager/6-3/release-notes/sp1-release-notes.html" format="html" scope="external"> Versionsinformation för AEM 6.3 Service Pack 1 </a>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> Som en del av en fullständig översyn av dokumentationssystemet för Experience Cloud har vi flyttat den AEM tekniska dokumentationen från den befintliga AEM <a href="https://helpx.adobe.com/se/support/experience-manager/6-3.html" format="html" scope="external"> docs.adobe.com- </a> plattformen till den centrala Helpx-plattformen. Du kan nu hitta AEM dokumentation på följande plats: </p> <p> 
     <ul id="ul_B7262532A35443D89A6D535434A35501"> 
      <li id="li_3DFCCC8E5A2A42A6BDF0140322803329"> <a href="https://helpx.adobe.com/se/support/experience-manager/6-3.html" format="https" scope="external"> AEM 6.3 Dokumentation </a> </li> 
      <li id="li_E8234E549AC24BBC94916CA73F61CB5C"> <a href="https://helpx.adobe.com/se/support/experience-manager/6-2.html" format="https" scope="external"> AEM 6.2 Dokumentation </a> </li> 
     </ul> </p> <p> <p>Obs!  AEM 6.1-dokumentation finns fortfarande på <a href="https://docs.adobe.com/docs/en/aem/6-1.html" format="html" scope="external"> https://docs.adobe.com/docs/en/aem/6-1.html </a>. Dokumentation från äldre AEM arkiveras <a href="https://helpx.adobe.com/se/experience-manager/aem-previous-versions.html" format="https" scope="external"> här </a>. </p> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Besök oss om du vill veta mer om AEM 6 Performance Tuning &amp; Best Practices tisdagen den 14 november 2017 kl. 10.30 - kl. 11.30 PST. </p> <p>Under den här sessionen kommer du att lära dig mer om följande: </p> <p> 
     <ul id="ul_75047C03AC224E06BBADE15FC0F78383"> 
      ...
      <li id="li_F25984ACAF8F43F4AA1B69D8B5EA027A">Planerar implementering av AEM Assets. </li> 
      <li id="li_CF37E5A4A4E14B7FBC4295E9442B7576">AEM datalagringsarkitektur. </li> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Analytics-integrering </p> </td> 
