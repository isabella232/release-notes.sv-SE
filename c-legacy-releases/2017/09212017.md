...
* Lagt till ny dokumentation, [skyddsprofiler för innehåll och Marketing Cloud ID-tjänsten](https://docs.adobe.com/content/help/en/id-service/using/reference/csp.html) som förklarar hur du tillåter anrop till Adobe-domäner som används av ID-tjänsten.
