...
* [Target](https://docs.adobe.com/content/help/en/target/using/release-notes/release-notes.htmltarget_release_notes.html) - länkar till lösningar
...
* Beräkning av rullande kohort: beräkna kvarhållning och urkunder baserat på tidigare tidsperiod, inte originalkohort.
...
* Ett problem med sökfunktionen i Rapporter &amp; Analytics har korrigerats och fungerar inte som den ska. (AN-170354)
...
* Ett problem som gjorde att användare omdirigerades till fel URL efter utloggning från Admin Console har åtgärdats. De omdirigeras nu till Admin Console inloggning. (AN-167880)
...
I 8.1 gjorde vi att Google Tag Manager gjorde DIL kompatibel med striktare säkerhetspolicyer. Den här versionen är bara tillgänglig från DTM och som fristående kod, inte [!DNL Launch] från AppMeasurement Audience Manager Module. Den här ändringen kommer att ingå i framtida versioner. (CORE-24189)
...
* Utcheckningskolumnen visades inte korrekt i listvyn i AEM Assets.
