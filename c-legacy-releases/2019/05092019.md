...
* I versionsinformationen [för](https://www.adobe.io/apis/experienceplatform/home/services/release-notes.html#!end-user/markdown/release-notes/release-notes-20190515.md) [!DNL Experience Platform] på Adobe.io finns de senaste uppdateringarna för [!DNL Experience Platform].
...
* Audience Analytics: Korrigerade ett problem som uppstod efter att ett målgruppsnamn ändrades i Audience Manager (AAM) - det uppdaterade namnet visades inte i Audience Analytics. (AN-176237)
* Ett problem som gjorde att användare inte kunde spara Analytics-segment i AAM har åtgärdats. Detta orsakades av befintliga AAM-mappar med både versaler och gemener. Alla mappar hanteras nu som skiftlägeskänsliga så att de synkroniseras. (AN-177934)
...
| -----------| ---------- | ---------- |
| Kommande ändring av _rapportsummeberäkningar_ | 16 april 2019 | Den 13 **juni 2019** gör Adobe Analytics att beräkningarna av _Report Total_ blir enhetliga för alla dimensioner och mätvärden. Detta resulterar i en förändring av summorna för vissa rapporter (vanligen rapporter om utkast eller kundattribut). Före den här ändringen inkluderades eller exkluderades _ospecificerade_ radposter i summan för vissa rapportsummor, oavsett om _Ospecificerad_ visades i rapporten. <br/>Från och med den 13 juni 2019 visas _Ospecificerad_ alltid i rapportsumman, även om den inte visas som en radpost i rapporten. Dessutom _finns_ segment som används eller _finns_ inte logik, vilket kan visa olika resultat för vissa dimensioner efter den här ändringen. Ändringen påverkar Analysis Workspace, Reports &amp; Analytics, Ad Hoc Analysis, Report Builder och API:t för rapportering. |
...
| Kommande ändring av felsökningskommandot i Analysis Workspace | 4 apr 2019 | Det konsolkommando som används för att aktivera felsökaren i Analysis Workspace ändras till adobeTools.debug.includeOberonXml den 13 **juni 2019**. |
...
Lär dig använda den senaste AEM-tekniken för att modernisera din AEM Sites-kodbas. [Modernisera din befintliga kodbas för Adobe Experience Manager-webbplatser](https://expleague.azureedge.net/labs/L761/index.html)
