...
| **[Konfigurera Twitter skräddarsydda målgrupper som självbetjäningsbaserade enhetsbaserade mål](https://docs.adobe.com/content/help/en/audience-manager/user-guide/features/destinations/device-based/twitter-tailored-audiences.html)** | Vi migrerar Twitter-destinationer till en modell för självbetjäningskonfiguration. I den här artikeln beskrivs vad du behöver göra för att befintliga Twitter-integreringar ska kunna fortsätta arbeta efter migreringen. |
