...
* Vi har åtgärdat ett fel där användare inte kan redigera Adobe Analytics-destinationer för att mappa segment manuellt. (AAM-49323)
...
* Vi har gjort en förbättring av arbetsflödet för att skapa egenskaper och segment. Nu kan du filtrera datakällan för att lagra egenskapen eller segmentet, så att datakällor som inte är Audience Manager utesluts (till exempel rapportsvitens datakällor från Adobe Analytics). (AAM-35899)
* Ett problem i API:t för datakällor där inställningen av frågeparametern inte `ExcludeReportSuites=true` exkluderade rapportsvitens datakällor från Adobe Analytics har åtgärdats. (AAM-48545)
...
[Programvarudistribution](https://downloads.experiencecloud.adobe.com/) är det nya användargränssnittet som är utformat för att förenkla sökning och hämtning av AEM-paket. Den har för närvarande betaversion och är endast tillgänglig för Adobe Managed Services.
...
Dokumentation för AEM Forms automatiserad formulärkonverteringstjänst finns nu tillgänglig. See [Introduction to Automated Forms Conversion service](https://helpx.adobe.com/experience-manager/Automated-Forms-Conversion-Service/introduction-to-automated-form-conversion-service.html).
...
Observera att det [!UICONTROL Control Panel] finns både Adobe Campaign Classic- och Adobe Campaign Standard-kunder på AWS. Det krävs inga uppgraderingar för att få tillgång till [!UICONTROL Control Panel].
