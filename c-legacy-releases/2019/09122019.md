...
* Ett problem har korrigerats där bastjänsterna [!UICONTROL People] och [!UICONTROL Offers] inte kunde nås från huvudmenyn på Experience Cloud. (AN-184294)
* Korrigerade ett problem med vänster räl i [!UICONTROL Analysis Workspace] oscillerande mellan att ha en rullningslist och inte ha någon rullningslist, vilket orsakade en flödande effekt. (AN-183904)
...
* Ett problem som gjorde att det inte gick att hämta utfallsrapporter i `.pdf/.xls/.rtf`-format har korrigerats. (AN-183165)
...
* Korrigerade ett problem med resursöverföring av schemalagda projekt som inte fungerade korrekt. Grupper hanteras i [!UICONTROL Admin Console] nu så vi kopierar dem inte mellan användare när vi överför resurser längre. (AN-183751)
