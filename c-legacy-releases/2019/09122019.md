...
* Korrigerade ett problem med att [!UICONTROL People] - och [!UICONTROL Offers] bastjänsterna inte var tillgängliga på Experience Cloud-huvudmenyn. (AN-184294)
...
Dokumentation för AEM Forms automatiserade konverteringstjänst för formulär finns nu tillgänglig. See [Introduction to Automated Forms Conversion service](https://helpx.adobe.com/experience-manager/Automated-Forms-Conversion-Service/introduction-to-automated-form-conversion-service.html).
...
Vi har lagt till nya funktioner för administratörsanvändare så att IP-adresser kan ansluta till Campaign Classic-instanser.
