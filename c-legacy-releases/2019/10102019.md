...
* Ett timeout-problem har korrigerats där det inte gick att läsa in segment i Ad Hoc Analysis. (AN-184654)
...
* **Integrering av Dynamic Media Viewer med Adobe Analytics och Adobe Launch**

   Med Dynamic Media Viewer-tillägget för Adobe Launch, tillsammans med versionen av Dynamic Media Viewer 5.13, kan kunder som har Dynamic Media, Adobe Analytics och Adobe Launch använda händelser och data som är specifika för Dynamic Media Viewer i sin Adobe Launch-konfiguration.
...
* **AEM-skrivbordsapp**
   ...
   AEM desktop app 2.0 är nu tillgängligt för kreatörer, marknadsförare och användare i olika branscher att arbeta med AEM Assets.
...
| Adobe Analytics Integration | (Endast annonsörer med Adobe Analytics) I Analysis Workspace är dimensionen &quot;Enhet (AMO ID)&quot;, som aldrig har samlat in data, inte längre tillgänglig. Om du vill rapportera online-data från Analytics använder du dimensionen &quot;Mobilenhetstyp&quot;. Om du vill rapportera om trafikstatistik (t.ex. klick, kostnad och visningar) per enhetstyp använder du rapporter i Advertising Cloud Search. |
