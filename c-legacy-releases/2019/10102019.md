...
* När du redigerar mål för Twitter-anpassade målgrupper är väljaren [!UICONTROL Account] bara aktiv om målet inte har tilldelats ett [!DNL Twitter Ads]-konto (AAM-49975).
