...
| Guardrail, robuskhet och skalbarhet | En rad förbättringar har lagts till i Campaign Classic. Förbättringar av säkerhet, tillförlitlighet och skalbarhet finns i versionsinformationen [för](https://docs.adobe.com/content/help/sv-SE/campaign-classic/using/release-notes/latest-release.translate.html)Campaign Classic. |
