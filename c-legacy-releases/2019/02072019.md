...
* [Korrigeringar och uppdateringar för Analytics](#aa-fixes)
...
#### Korrigeringar och uppdateringar för Analytics
...
**Analytics-korrigeringar (allmänna)**

* **Rapporter och Analytics:** Ett problem som gjorde att användare inte kunde dela rapporter med andra användare har korrigerats. (AN-172301)
...
* [Friskrivningar av bestruket finpapper från AEM Forms](https://helpx.adobe.com/aem-forms/kb/aem-forms-releases.html)
...
### Integration med Adobe Analytics
