...
Den 7 februari 2019 kommer Adobe Analytics för video och ljud att släppa en namnändring. Medieinitierare kallas nu _Mediestartningar_.
...
* **Rapporter och analyser:** Ett problem som hindrade användare från att dela rapporter med andra användare har korrigerats. (AN-172301)
* **Admin:** Korrigerat ett problem med redigeringsfunktionen i den äldre administratörens användarhantering: När du har valt en användare och klickat på Redigera visas inga data om användaren. (AN-170705)
...
I och med uppgraderingen till en ny version av [Tableau](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_comproc.html) har vi ändrat datavisualiseringsmetoden för överlappningsrapporter. Se skärmbilden i rapporten Trait-to-Trait Overlap Report. Se [Överlappningsrapport för spår till trait](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_overlap_reports.html).

**Överlappningsrapport för segment till trait**

I och med uppgraderingen till en ny version av Tableau har vi ändrat datavisualiseringsmetoden för överlappande rapporter. Se skärmbilden i Överlappningsrapporten Segment-till-Trait. Se [Överlappningsrapport för segment-till-höger](https://experiencecloud.adobe.com/resources/help/en_US/aam/c_segment_trait_overlap.html)
