...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> Förbättringar av Analysis Workspace </td> 
   <td colname="col2"> 
    <ul id="ul_56E06D32414D47ADB46F7AA5DF1B4702"> 
     ...
     <li id="li_691BC0CB4E3C48B787F5E167DB74D00E">Möjlighet att ta bort alla visualiseringar i en panel och alla paneler i ett projekt. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="keyword"> Analytics </span> lade till två nya globala användarbehörigheter i <span class="ignoretag"> Admin <span class="uicontrol"> &gt; </span> Användarhantering <span class="uicontrol"> &gt; </span> Grupper <span class="uicontrol"> </span> </span>: </p> 
    <ul id="ul_2C1E01D051034441B5DAE93F704DFAB7"> 
     <li id="li_7271E3EF48E14068A8518ADEAC833B02"> <span class="wintitle"> Åtkomst till analysarbetsyta </span> </li> 
  ...
  <tr> 
   <td colname="col1"> Förbättringar av datalager </td> 
   <td colname="col2"> 
    <ul id="ul_6CDE5231B5FE430AB8D8F1F4643065D7"> 
     <li id="li_1405D9F3C1AB479C9D3767C2251E5550">Allmänt <span class="wintitle"> datalager - </span> stabilitet och prestandaförbättringar. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_2CE40E9BD0EB454A828AC67608259394">Ett problem har korrigerats där eVars för videorapportering som konfigurerats i SiteCatalyst 14 inte visades korrekt i <span class="keyword"> Adobe Analytics </span> 15. (AN-122453) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
      ...
      <li id="li_2DAC2D537D9442AF8B24CB90F9EB9C54">Ett problem som förhindrade schemaläggning av Analysis Workspace-projekt i något format har korrigerats. (AN-123378) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BCA85EDE14C2445C8C10BDD77ED342A6"> 
      ...
      <li id="li_00A0F865791A4803806F850C7AE23BDC">Korrigerade ett problem som resulterade i en ändring av hur rader av typen "Ingen" beräknades för besöksnivådimensioner med "nyligen"-allokering. (AN-12279) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_0E0843493FA84006A1CD1A99979A6D46"> 
      ...
      <li id="li_5086DFC01E444C05810C5C71ADC38FA1">Korrigerade ett problem med åtkomst till <span class="wintitle"> sidan </span> för hämtning av aktivitetskarta för icke-adminanvändare. Korrigeringen innebär att icke-adminanvändare inte längre behöver vara en del av <span class="term"> gruppen med </span> äldre klickkartor för att kunna hämta <span class="wintitle"> aktivitetskarta </span>, bara medlemmar i gruppen med åtkomst till <span class="wintitle"> aktivitetskartor </span> . (AN-125144) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_9A4E12DD7F254411AA9452735D63CA80"> 
      <li id="li_A06DD2F318FF4187A23786FB44E2A8E6">Korrigerad regression som introducerades i underhållsutgåvan från maj som orsakade rapportsegmentering på kundens lojalitets&amp;gt; Lojal kund att inte returnera data. (AN-124498) </li> 
      <li id="li_0C3FE78BF8874CA7B06356E3915B1A69">Korrigerade ett problem med att marknadsföra eVars när eVar-numret var större än 75, vilket orsakade en felmatchning av data mellan <span class="wintitle"> Data Warehouse </span> och <span class="wintitle"> Reports &amp; Analytics </span>. (AN-123328) </li> 
...
<!-- <draft-comment> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Mer information finns i uppdateringarna <a href="https://marketing.adobe.com/resources/help/en_US/insight/whatsnew/c_release_notes_insight_62.html" format="http" scope="external"> </a> för Data Workbench 6.2. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* På Audience Marketplace kan dataleverantörer nu uppdatera ett tariffkort för aktiva dataflöden. (AAM-23476)

**Ny och reviderad dokumentation**

Reviderad:

* [Samla in data för kampanjexponering via pixelanrop](https://marketing.adobe.com/resources/help/en_US/aam/c_doc_updates.html)
...
* Ett problem har korrigerats där vissa avsnitt saknades i de hämtade översiktsrapporterna för [!UICONTROL  moderering] med specifika datumintervall. (AS-34917)
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Att leverera komplexa webbupplevelser snabbt är en utmaning. Under denna utbildning kommer du bland annat att lära dig vanliga fallgropar för implementering, teori, exempel och bästa metoder. Det finns också en demonstration av verktyg som täcker följande områden: </p> <p> 
     <ul id="ul_3480CEB0C48F40BABEEC8146C8E1518E"> 
      ...
      <li id="li_C217FB0BA3EF4FBEA5B65020AEE708A4"> <p>Identifiering av problem som rör långsamma AEM-serverförfrågningar. </p> </li> 
...
<table id="table_D0FFD1AD5C0D4BAA81BAEC60E8B2290F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Gems on Adobe Experience Manager är en serie tekniska djupdykningar som levereras av Adobes experter. Den här serien kompletterar produktdokumentation och tekniska kanaler och gör det möjligt för utvecklare att kontakta och utforska ett specifikt ämne. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D245BAB62A304D5B9018375ABFEFFC09"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Nya kunder kan snabbt implementera <span class="keyword"> Analytics </span> med hjälp av <span class="term"> "Getting Started with Adobe Analytics"- </span> metoden och sedan driftsätta Analytics med Dynamic Tag Management. </p> </td> 
