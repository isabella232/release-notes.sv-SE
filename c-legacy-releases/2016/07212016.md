...
Produktdokumentation finns i [Adobe Mobile Services](https://marketing.adobe.com/resources/help/en_US/mobile/) . Om du vill visa versionsinformation för tidigare versioner expanderar du *Tidigare versionsinformation* i den vänstra rutan.

### Dynamisk tagghantering {#dtm}

| Funktion | Beskrivning |
|---|---|
| Tjänstverktyget för Marketing Cloud ID | Alternativet att låta Marketing Cloud ID-tjänstverktyget i DTM läsas in överst på sidan är nu aktiverat som standard. |

**Korrigera**

När verktyget Marketing Cloud ID Service läggs till väljs nu **[!UICONTROL Automatiskt begärande av besökar-ID]** som standard. (DTM-8189)
...
**Viktiga meddelanden om Marketing Cloud ID-tjänsten**
  ...
  <tr> 
   ...
   <td colname="col2"> <p>CORS tillåter webbläsare att begära resurser från en annan domän än den aktuella domänen. Tjänsten <span class="keyword"> Marketing Cloud </span> ID stöder CORS-standarder för att möjliggöra resursbegäranden på klientsidan, från olika källor. ID-tjänsten återgår till JSONP-begäranden i webbläsare som inte stöder CORS. (AAM-23988) </p> <p>Se: </p> 
    <ul id="ul_36247A565B5842B3A5F0553440327BC8"> 
     <li id="li_1DBEEFBA4C4B452BAADCE86B102DD337"> <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-cors.html.html" format="https" scope="external"> CORS-stöd i Marketing Cloud ID Service </a> </li> 
...
* Ändrade standardvärdet ` loadTimeout` till 30 000 millisekunder (30 sekunder) från 500 millisekunder. Se [Variabler som används av ID-tjänstens getInstance-funktion](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid_getinstance.html). (MCID-96)
...
* Nytt: Implementera [Marketing Cloud ID Service för analys och Audience Manager](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-setup-aam-analytics.html)
* Reviderad: [Testa och verifiera Marketing Cloud ID-tjänsten](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-test-analytics.html)

Se även produktdokumentationen för [Marketing Cloud ID Service](https://marketing.adobe.com/resources/help/en_US/mcvid/) .
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>I oktober 2016 kommer Analysadministratörer att kunna hantera användare och produktkonfigurationer (grupper) på <span class="wintitle"> Enterprise Dashboard </span>. Enterprise Dashboard är administrationsgränssnittet för Adobes Marketing, Creative och Document Clouds. </p> <p>Du kan: </p> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nya kunder som loggar in på <span class="keyword"> Analytics </span> via <span class="keyword"> Marketing Cloud </span> kan snabbt implementera <span class="keyword"> Analytics </span> med hjälp av"Getting Started with Adobe Analytics <span class="term"> </span> modal" och sedan driftsätta Analytics med Dynamic Tag Management. </p> <p>Den här förenklade implementeringen hanteras av Dynamic Tag Management och gör att du kan: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_BB48AEAB77574B79A823FBA770449105"> 
      <li id="li_45679243BB024A6A90EF654D9DCF7D0F"> Flikarna har ordnats om och fått nya namn på <span class="wintitle"> panelen Inställningar för </span> aktivitetskarta: 
      ...
      <li id="li_11C668A5F12F46C0969C279F33F3AC6D">Tog bort övertäckningsstatistik som inte stöds (nya besökare och nya kunder) från aktivitetskartan. (AN-124056) </li> 
      <li id="li_44571DB551274B25A37C13F0D0A8505A"> Live-läget för aktivitetskarta rapporterar nu om alla länkar som finns på webbsidan. (AN-116094) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_21AA1745F6154EFAA67D00D9531417D3"> 
      <li id="li_77E57F08C316489D959009967CB160C9"> Lägg till segmentstöd för sidvisningar i datalagret (AN-125067). </li> 
      ...
      <li id="li_4D264642BB344468A8A6E2D6EB3B7C82">Nya e-postdistributionslistor som skapas efter att gränssnittets Virtual Report Suite-ändringar har ändrats kommer nu att fungera i Data Warehouse. (AN-123842) </li> 
...
<!-- <draft-comment> 
    ...
    </ul> <p> <b>Se även:</b> ID-tjänst <a href="../../c-legacy-releases/2016/07212016.md#mcvid" format="dita" scope="local"> för Marketing Cloud </a> (tidigare <span class="term"> besökar-ID-tjänst </span>) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* [Geogeting med plattformsspecifika tangenter](https://marketing.adobe.com/resources/help/en_US/aam/c_tb_platform_vars.html). Innehåller en uppdaterad nyckellista som innehåller de senaste värdena.
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_2ACBBBD7E090426480C9A2745358201E"> 
      ...
      <li id="li_D5491DC2242645C0944457DAC616843C"> <p> <a href="https://docs.adobe.com/docs/en/aem/6-2/deploy/application-server-install.html" format="https" scope="external"> Installationsdokumentation för AEM 6.2 Application Server </a> uppdaterades. </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
Följande tabell innehåller ett urval av länkar till föreslagna ämnen. De här avsnitten kan hjälpa dig att få ut det mesta av din implementering och användning av AEM.
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>AEM innehåller det klassiska och pekoptimerade användargränssnittet. Därför kan du använda avsnittet"Rekommendationer för användargränssnitt för kunder" för att avgöra vilket gränssnitt som är bäst för dig. Den här informationen är användbar vid projektimplementering eller när du uppdaterar från en tidigare version. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Innehåller bland annat en grundläggande översikt över AEM-komponenter, inklusive komponenter i det klassiska användargränssnittet och det pekoptimerade användargränssnittet. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Förbättra dina kunskaper om de uppgifter och överväganden som krävs för att driftsätta AEM med MongoDB. </p> </td> 
  </tr> 
  <tr> 
