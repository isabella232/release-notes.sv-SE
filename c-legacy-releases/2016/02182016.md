---
description: Marketing Cloud Nya funktioner inkluderar förbättringar av Marketing Cloud Assets och ett förbättrat arbetsflöde för att länka lösningskonton till ditt Adobe ID. Adobe Mobile Updates to Apteligent and appFigures integration. Behörighetskonfiguration för Analytics Ny realtidsrapport i Admin Tools. Audience Manager inaktiverar dataflöden i Audience Marketplace. Service Pack och snabbkorrigeringar för Experience Manager. Dessutom finns allmänna korrigeringar och förbättringar för underhållsutgåvan från februari.
keywords: release notes
seo-description: Marketing Cloud Nya funktioner inkluderar förbättringar av Marketing Cloud Assets och ett förbättrat arbetsflöde för att länka lösningskonton till ditt Adobe ID. Adobe Mobile Updates to Apteligent and appFigures integration. Behörighetskonfiguration för Analytics Ny realtidsrapport i Admin Tools. Audience Manager inaktiverar dataflöden i Audience Marketplace. Service Pack och snabbkorrigeringar för Experience Manager. Dessutom finns allmänna korrigeringar och förbättringar för underhållsutgåvan från februari.
...
* Ett problem som förhindrar länkning och enkel inloggning för Analytics har korrigerats. Det här problemet innehöll meddelandet&quot;Meddelande: Felmeddelandet: FEL: IMS SSO misslyckades: Det gick inte att hitta det länkade företaget.&quot;

**Känt fel**

Om du använder dynamisk tagghantering via **[!UICONTROL  Marketing Cloud > Activation]** gränssnittet, men ditt konto för dynamisk tagghantering inte är länkat till Marketing Cloud (Adobe ID), kan du inte logga in på dynamisk tagghantering. Du undviker det här problemet genom att navigera direkt till [https://dtm.adobe.com](https://dtm.adobe.com) på en ny flik i webbläsaren.
...
<table frame="all" colsep="1" rowsep="1" id="table_812CAB7DDC364DAABB7CDEDE55532E39"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> <p>Från och med Android SDK 4.8.3 påverkar sekretessinställningarna som anges med <span class="codeph"> metoden setPrivacyStatus </span> aktivitet från <span class="keyword"> Analytics </span>, <span class="keyword"> Target </span> och <span class="keyword"> Audience Manager </span>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
### Viktiga meddelanden om Analytics {#analytics_notices}

>[!IMPORTANT]
>
>I följande tabell visas Analytics-meddelanden om problem som kan påverka datainsamling och -rapportering, produktlivslängdens slut och så vidare.
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> I början av februari 2016 har Adobe Analytics inte längre stöd för SSLv3. Ändringen påverkar Report Builder, datainsamlingsbegäranden och förfrågningar till Analytics Web Services API:er. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A51B298EEEB5482383505B8C5A79E1B9"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> Rapporter och Analytics-korrigeringar </td> 
   <td colname="col2"> 
  ...
  <tr> 
   <td colname="col1"> Ad hoc analysis korrigeringar </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b> <span class="keyword"> AppMeasurement </span> for Other Platforms</b> </p> <p>Se <a href="https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/release/index.html" scope="external" format="https"> Versionshistorik för AppMeasurement </a> nedan för en versionshistorik för <span class="keyword"> AppMeasurement </span> på följande plattformar: </p> 
    ...
    </ul> <p> <b>Se även:</b> <a href="../../c-legacy-releases/2016/02182016.md#mcvid" format="dita" scope="local"> ID-tjänst för Marketing Cloud </a> (tidigare <span class="term"> besökar-ID-tjänst </span>) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Analytics Web Services (SOAP och REST API:er) </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> AEM 6.1 Service Pack 1 är en viktig uppdatering som innehåller prestanda, stabilitet, säkerhet och viktiga kundkorrigeringar och förbättringar som släppts sedan den allmänna tillgängligheten av AEM 6.1 i maj 2015. SP1 kan installeras på AEM 6.1 GA. </p> <p> I översikten på den här sidan visas de ändringar som har lagts till med SP1. Några av huvudpunkterna i Service Pack är: </p> 
    <ul id="ul_F553DE837B8C4F67A31D224F93225E8F"> 
     ...
     <li id="li_9C15CE0BD76D46F9B0917B17700BB5BD"> Innehåller viktiga korrigeringar för integrering av Adobe Target. </li> 
...
<table id="table_8EE2C5FD9964403D91FFBCDF5FECEACE"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Använda anpassade xtypes i användargränssnittet för Adobe Experience Manager 6 Touch. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> Förbättra dina kunskaper om de uppgifter och överväganden som krävs för att distribuera Adobe Experience Manager med MongoDB. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_D245BAB62A304D5B9018375ABFEFFC09"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>En produktjämförelsetabell har lagts till för Analytics-produkter. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Analytics-administratörer: Om du är administratör i Marketing Cloud kan du läsa <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/user_mgmt_admin.html" format="https" scope="external"> Användare och grupper </a> för att få uppdaterad information om hur du mappar Analytics-grupper till bredare Adobe-grupper och lägger till eller lägger till användare via <a href="http://adminconsole.adobe.html/#" format="http" scope="external"> Enterprise Dashboard </a>. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se avsnittet <a href="../../c-legacy-releases/2015/03192015.md#analytics" format="dita" scope="local"> New Features (Nya funktioner) </a> i Analytics för en genomgång av den nya dokumentationen för Analytics-utgåvan våren 2015. </p> </td> 
   <td colname="col3"> <p>19 mars 2015 </p> </td> 
  </tr> 
  <tr> 
