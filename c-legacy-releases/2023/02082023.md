...
Och mycket mer! Se [Experience League Events](https://experienceleague.adobe.com/events?lang=sv/) för ett fullständigt schema.
...
>[!IMPORTANT]
>
>Adobe rekommenderar att du [uppgradera till den senaste 1.9.6-versionen](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets-view/integrations/workfront-connector-install.html?lang=en) i [!DNL Workfront] för Experience Manager med utökad kontakt.
