...
* **Stöd för 3D-resurser har lagts till i Dynamic Media**
   ...
   * Om du har AEM as a Cloud Service läser du [Arbeta med 3D-resurser i Dynamic Media](https://docs.adobe.com/content/help/sv-SE/experience-manager-cloud-service/assets/dynamicmedia/assets-3d.html).
...
| 23 juni 2020 | [Bearbetningsprofiler](https://docs.adobe.com/content/help/en/experience-manager-learn/assets/configuring/processing-profiles.html) | Video | Bearbetningsprofiler definierar de återgivningar som ska skapas för resurserna i AEM as a Cloud Service. |
