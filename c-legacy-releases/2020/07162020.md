...
| 3 juni 2020 | [Hantera inskickande av HTML5-formulär – självstudiekurs](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/html5-forms/handle-mobile-form-submission.html) | Artikel | Lär dig hur du kommer åt inskickade data i den anpassade överföringshanteraren. |
...
* Granskning av deldomänleverans – [Läs mer](https://experienceleague.adobe.com/docs/control-panel/using/subdomains-and-certificates/setting-up-new-subdomain.html)

* Hantering av GPG-nycklar – [Läs mer](https://experienceleague.adobe.com/docs/control-panel/using/instances-settings/gpg-keys-management.html)
