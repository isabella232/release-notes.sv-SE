...
* **AEM as a Cloud Service**
   ...
   * AEM Commerce är nu tillgängligt i molntjänsten. Läs [Komma igång med AEM Commerce som en molntjänst](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/commerce/getting-started.html).
   ...
   * Cloud Manager-ledningar har nu stöd för kundspecifika variabler och hemligheter. Se [Ledningsvariabler.](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/onboarding/getting-access/creating-aem-application-project.html#pipeline-variables)
...
| 21 juli 2020 | [Skapa en språkkopia](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/multi-site-management/create-launguage-copy.html) | Självstudiekurs | Lär dig hur du skapar en [!UICONTROL Language Copy] för din AEM-webbplats med [!UICONTROL Create Language Copy wizard]. |
