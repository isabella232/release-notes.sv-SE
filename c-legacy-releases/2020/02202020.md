...
* **Kromiumbaserad webbläsare Microsoft® Edge:** Den här versionen innehåller ändringar som identifierar den Chromiumbaserade webbläsaren Microsoft® Edge (version 79 och senare) för rapportering.
...
* **Tutorials för Experience Manager as a Cloud Service**
   ...
   Kom igång snabbt med självstudiekurserna [för Experience Manager as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/overview.html?lang=en).
...
* **Microsoft® Dynamics  _Change Owner in Microsoft®_ Flow Action:** Ändra en lead- eller kontaktägare direkt från Marketo Engage.
