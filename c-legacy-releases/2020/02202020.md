...
* **Labs (förhandsvisning av teknik):** Med den här nya Analytics-funktionen kan du testa nya funktionsprototyper i produktionen och ge värdefull feedback till Adobe. [Läs mer...](https://docs.adobe.com/content/help/en/analytics/analyze/tech-previews/overview.html)
...
* Korrigerade ett problem med namnet på ett publicerat segment som uppdaterades i Analytics som inte uppdaterades i Audience Manager inom 24 timmar. (AN-199974)
...
| Funktion | Beskrivning |
|----|----|
| [Aktivitetsanvändningsrapportering](https://docs.adobe.com/content/help/en/audience-manager/user-guide/features/administration/activity-usage-reporting.html) | Med den här funktionen kan du [!UICONTROL Activity Usage Report] visa och spåra aktivitetsanvändningen för din Audience Manager-instans, vilket ger dig en tydlig uppfattning om hur din aktivitetsanvändning ser ut jämfört med ditt avtalsenliga åtagande. |
...
* Korrigerade ett fel som medförde att dataexportvalet inte sparades när dataexportkontroller sparades för nya eller befintliga mål, för kunder som använder integreringen med Adobe Experience Platform (AAM-52814).
...
* **Cloud Manager 2020.2.0**
   ...
   Cloud Manager 2020.2.0 förenklar självbetjäningshanteringen för sandlådor för Adobe Experience Manager som en Cloud Service.
...
* **Självstudiekurser för AEM som Cloud Service**
...
* **Interaktiv AEM Forms Batch-API för kommunikation**

   Batch-API för interaktiv AEM Forms-kommunikation gör det möjligt för kunderna att producera flera interaktiva kommunikationer, automatiskt eller on-demand. Kunderna kan generera utdata för tryck och webb samtidigt.
...
* **Plattformar som stöds av AEM Forms på JEE**
