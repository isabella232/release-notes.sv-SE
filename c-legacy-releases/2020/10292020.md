...
Mer information om Platform launch finns i [Versionsinformation för Experience Platform Launch](https://docs.adobe.com/content/help/sv-SE/launch/using/intro/release-notes/current.html).
...
* **AEM as a Cloud Service**
   ...
   * **Adobe Experience Manager Assets as a Cloud Service**
      ...
      * Mer information om följande förbättringar finns i [nyheter i Brand Portal.](https://docs.adobe.com/content/help/en/experience-manager-brand-portal/using/introduction/whats-new.html)
