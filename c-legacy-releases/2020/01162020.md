...
Produktdokumentation finns i [Adobe Analytics Help Home](https://experienceleague.adobe.com/docs/analytics.html?lang=en).
...
| Ny [!UICONTROL Identified State]-dimension för analys över flera enheter (CDA) | Vi lägger till en ny dimension med namnet [!UICONTROL Identified State] i den virtuella CDA-rapportsviten. Dimensionen har två möjliga värden, _Identifierad_ och _Oidentifierad_. __ Identifierad innebär att personen har identifierats av enhetsdiagrammet. __ Oidentifierad innebär att personen inte har identifierats av enhetsdiagrammet.<br>Det innebär att CDA-användare nu kan skapa beräknade värden, till exempel  [!UICONTROL Device Graph Coverage], som beskriver hur många av personerna i den virtuella rapportsviten som är kända av enhetsdiagrammet. Det här måttet är användbart för felsökning av CDA-komprimeringshastigheter. Om få personer identifieras blir graden av syfilis låg. |
