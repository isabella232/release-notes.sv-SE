...
| Kommande ändring av `createDate` fält för Analytics-användare | 30 augusti 2019 | I oktober eller november 2019 uppdaterades fältet för Analytics-användare från PST till ett korrekt formaterat datum- och tidsvärde med tidszonsinformation. `createDate`(AN-183468) |
...
* Korrigerade ett problem i [!UICONTROL Create Destination] arbetsflödet där avsnittet skulle försvinna och arbetsflödet inte skulle kunna slutföras när du valde **[!UICONTROL Integrated Platforms]** som [!UICONTROL Category][!UICONTROL Basic Information] . (AAM-52397, AAM-52414)
