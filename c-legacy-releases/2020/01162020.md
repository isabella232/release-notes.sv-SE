...
* **AEM 6.5.3.0** AEM 6.5, Service Pack 3.0 (6.5.3.0 släppt 12 december 2019) är en viktig uppdatering som innehåller viktiga kundkorrigeringar som släppts sedan den allmänna tillgängligheten AEM 6.5 april 2019.
...
* **NYHET: AEM som en Cloud Service**
   ...
   * [Onboarding](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/overview/introduction.html)
