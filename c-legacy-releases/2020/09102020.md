...
* [Analytics](#analytics)  (Uppdaterat 29 september 2020) och [Customer Journey Analytics](#cust-journey)
...
* Augustiversion - [Läs mer](https://docs.adobe.com/content/help/en/journeys/using/release-notes/release-notes.html#august-release)
...
| ----------- | ---------- | ------- |
| [!UICONTROL Cross-Device Analytics]: Tillgänglighet i EMEA och APAC | 31 augusti 2020 | [Enhetsövergripande ](https://docs.adobe.com/content/help/sv-SE/analytics/components/cda/overview.html) analyser och privata diagram är tillgängliga för kunder i EMEA och APAC. |
...
* Korrigerade ett problem i [!UICONTROL People-based destinations], där segment som mappats till Facebook inte skulle uppdateras eftersom fältet `traitAlias` saknas i ett API-anrop. (AAM-55952)
...
* **[!UICONTROL AEM as a Cloud Service]**
   ...
   * Möjlighet i [!UICONTROL AEM as a Cloud Service] att [återställa sidor och undersidor (sidträd) till en tidigare version](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/sites/authoring/features/page-versions.html#reinstating-versions).
...
* **CDN Invalidation in[!UICONTROL Dynamic Media]**
   ...
   Mer information finns i [Cachevärdet för CDN har inte verifierats med hjälp av [!UICONTROL Dynamic Media].](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/assets/dynamicmedia/invalidate-cdn-cache-dynamic-media.html)

* **På- och avaktiveringstider för publicering av sidor**

   När du publicerar sidor med [På- och Av-tider](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/sites/authoring/fundamentals/page-properties.html#basic) går du till fliken Grundläggande i Sidegenskaper och nu kan du [förkonfigurera Automatisk replikering](https://docs.adobe.com/help/en/experience-manager-cloud-service/operations/replication.html#on-and-off-times-trigger-configuration).
...
* [Versionsinformation för AEM 6.4 Cumulative Fix Pack](https://docs.adobe.com/content/help/en/experience-manager-64/release-notes/cfp-release-notes.html)
...
* [Användarhandböcker för AEM as a Cloud Service](https://docs.adobe.com/content/help/sv-SE/experience-manager-cloud-service/landing/home.html)
