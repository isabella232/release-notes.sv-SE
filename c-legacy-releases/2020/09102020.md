...
* [Analyser](#analytics) (Uppdaterat 29 september 2020) och [Customer Journey Analytics](#cust-journey)
...
Se [Ackumulerade versionsinformation](https://experienceleague.adobe.com/docs/core-services/interface/release-notes/release-notes.html) för den senaste versionsinformationen för Experience Cloud-gränssnittet (kundattribut, målgrupper, användar- och produktadministration).
...
* [Arbetsyta för datavetenskap](https://experienceleague.adobe.com/docs/experience-platform/release-notes/latest.html#dsw)
...
* Version i augusti - [Läs mer](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html#august-release)
...
| ----------- | ---------- | ------- |
| [!UICONTROL Cross-Device Analytics]: Tillgänglighet i EMEA och APAC | 31 augusti 2020 | [Enhetsövergripande analys](https://experienceleague.adobe.com/docs/analytics/components/cda/overview.html?lang=sv) och ett privat diagram finns för kunder i EMEA och APAC. |
...
* ([!UICONTROL Customer Journey Analytics]) Korrigerade ett behörighetsproblem med delade projekt i CJA. (AN-226592)
...
* Ett problem där segment som använder algoritmiska modeller från tredje part inte visades i [!UICONTROL Segment Usage] visa i [!UICONTROL Audience Marketplace]. (AAM-54595)
...
* Korrigerat ett problem på sidan med destinationslistan där **[!UICONTROL Lifetime]** i **[!UICONTROL Look Back Window for Metrics]** ett filter returneras en tom sida. (AAM-49732)
* Ett problem har korrigerats på kontrollpanelen för egenskaper där, vid filtrering från **[!UICONTROL All Traits]** till valfritt filter (**[!UICONTROL Rule-based]**, **[!UICONTROL Onboarded]**, osv.) uppdateras måtten, men inte trait-namnet och ID:t. (AAM-55823)
* Korrigerade ett problem i [!UICONTROL People-based destinations], där segment som mappas till Facebook inte uppdateras på grund av att ett `traitAlias` i ett API-anrop. (AAM-55952)
* Korrigerade ett problem i [!UICONTROL Trend Reports] där diagrammet inte skulle uppdateras när du växlar mellan egenskaper och segment (AAM-54736)
* Korrigerade ett problem i [!UICONTROL Look-alike Modeling] där du trycker på **[!UICONTROL Pause]** kontrollen pausar inte modellen, utan stänger den i stället. (AAM-56121)
...
* **[!UICONTROL AEM as a Cloud Service]**
   ...
   Nyheter [!UICONTROL AEM as a Cloud Service]? Bland nyheterna finns följande:

   * Möjlighet att [!UICONTROL AEM as a Cloud Service] till [återställa sidor och undersidor (sidträd) till en tidigare version](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/features/page-versions.html#reinstating-versions).
   * Videoomkodning stöds nu med tillgångsmikrotjänster, med en ny [!UICONTROL Video] i [!UICONTROL Processing Profiles] skärm med stöd för konfiguration av videobithastighet och dimensioner (utdataformatet är MP4 med H.264-kodek). Mer information finns i [hantera videomaterial.](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/manage/manage-video-assets.html#transcode-video) För fler omkodningsalternativ och videoleverans [!UICONTROL Dynamic Media] kan användas.
   ...
   * [!UICONTROL Content Audit] är en funktion aktiverad på [!UICONTROL Cloud Manager Sites Production Pipelines]. The [!UICONTROL Production Pipeline] konfiguration för program med [!UICONTROL Sites] innehåller nu en tredje flik med namnet **[!UICONTROL Content Audit]**. När en produktionsprocess körs, en ny [!UICONTROL Content Audit] steg kommer att ingå i utvecklingsarbetet efter anpassade funktionstester som utvärderar webbplatsen mot ett antal dimensioner, inklusive prestanda, SEO (sökmotoroptimering), tillgänglighet, bästa praxis och PWA (Progressive Web App).
   * Nyligen skapade miljöer i [!UICONTROL Assets] program konfigureras nu automatiskt med [!UICONTROL Smart Content Services].
   * Vilolägen miljö kan tas bort från viloläget via Cloud Managers **[!UICONTROL Overview]** sida.
   * Möjlighet att utföra Experience Checks på sidor, med [!DNL Google Lighthouse]. Som en del av [!UICONTROL Cloud Manager] kan upp till 25 sidor kontrolleras och valideras mot upplevelsenyckeltal, och poängen visas i [!UICONTROL Cloud Manager] Gränssnitt.
...
* **Experience Manager [!UICONTROL Desktop App] 2.0.3.2**
   ...
   * Se [versionsinformation.](https://experienceleague.adobe.com/docs/experience-manager-desktop-app/using/release-notes.html)
...
* **AEM[!UICONTROL Assets Brand Portal]**
   ...
   * Se [versionsinformation.](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/introduction/brand-portal-release-notes.html)

### **Självhjälp**

* **Nya verktyg för[!UICONTROL AEM as a Cloud Service Transitions]**

   * AIO-CLI-plugin för att sammanställa kodomfaktoriseringsverktygen så att utvecklare kan anropa och köra verktyg för kodomfaktorisering från ett och samma ställe. Se GitHub-resursen [aio-cli-plugin-aem-cloud-service-migration](https://github.com/adobe/aio-cli-plugin-aem-cloud-service-migration) för mer information.
   * [!UICONTROL AEM Dispatcher Converter] utökas till stöd för konverteringar av lokalt och Adobe [!UICONTROL Managed Services Dispatcher] konfigurationer i AEM as a Cloud Service kompatibla Dispatcher-konfigurationer. Se GitHub-resursen [AEM Cloud Service Dispatcher Converter](https://github.com/adobe/aem-cloud-service-source-migration/tree/master/packages/dispatcher-converter) för mer information.
...
* **CDN Invalidation in[!UICONTROL Dynamic Media]**
   ...
   Du kan nu skicka en begäran inifrån [!UICONTROL Dynamic Media] för att få CDN-cachen att upphöra inom några minuter. Den här funktionen är användbar när du uppdaterar resurser och du vill att ändringarna ska börja gälla direkt på webbplatsen.

   Se [CDN-cachen är ogiltig [!UICONTROL Dynamic Media].](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/invalidate-cdn-cache-dynamic-media.html)

* **På- och avaktiveringstider för publicering av sidor**

   Vid publicering av sidor med [På- och avaktiveringstider](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/fundamentals/page-properties.html#basic), se fliken Grundläggande i Sidegenskaper, du kan nu [förkonfigurera automatisk replikering](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/operations/replication.html#on-and-off-times-trigger-configuration).

* **[!UICONTROL Core Components]**

   [!UICONTROL Core Components] version 2.11.0 har stöd för AMP och finns nu tillgänglig tillsammans med [redigeringsdokumentation](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/introduction.html) och [information om utvecklare och projektnedladdning finns på GitHub.](https://github.com/adobe/aem-core-wcm-components)

* **[!UICONTROL Forms]**

   * Uppdaterat [Gov och We.Finance - referenssajter genomgående](https://experienceleague.adobe.com/docs/experience-manager-65/forms/getting-started/aem-forms-reference-collaterals/forms-gov-reference-site-user-demo.html) är tillgängliga. Du kan använda dessa referenswebbplatser för att lära dig kompletta arbetsflöden för att skapa och leverera formulär för myndigheter och finansiella vertikaler.
   * A [exempelimplementering av Spara som utkast till SPI](https://experienceleague.adobe.com/docs/experience-manager-65/forms/interactive-communications/prepare-send-interactive-communication.html#sample-ccrDocumentInstance-spi) är tillgängligt. Du kan använda exemplet för att implementera [!UICONTROL Save as a Draft] för [!UICONTROL Interactive Communications Agent UI]. Det hjälper agenterna att spara och hämta utkast för att snabba upp genereringen av interaktiv kommunikation.
   * Instruktion till [installera och validera installationen av visuella C++-omdistribuerbara produkter](https://experienceleague.adobe.com/docs/experience-manager-65/forms/install-aem-forms/osgi-installation/installing-configuring-aem-forms-osgi.html#automatic-installation-visual-studio-redistributables) vid installation [!UICONTROL AEM Forms] tilläggspaketet är tillgängligt. Detta bidrar till att minska antalet fel i samband med installation och konfiguration av återdistribuerbara Visual C++-filer.
   * [Konfigurera Adobe Sign med adaptiva formulär](https://experienceleague.adobe.com/docs/experience-manager-65/forms/adaptive-forms-advanced-authoring/adobe-sign-integration-adaptive-forms.html) Dokumentationen är noggrant testad och omgjord. Nu med ytterligare instruktioner för smidig konfigurering av Adobe Sign med anpassningsbara formulär.
   * ([!UICONTROL AEM Forms] på JEE) Dokumentation till [skapa en hanterare för inbjudan till externa användare för tjänsten Rights Management](https://experienceleague.adobe.com/docs/experience-manager-65/forms/developer-reference/programming-aem-forms-jee/developing-spis-aem-forms/creating-invite-external-users-handler.html) är tillgängligt.
...
| 17 augusti 2020 | [Konfigurera åtkomst till AEM](https://video.tv.adobe.com/v/39230) | Video | Upptäck hur användare autentiserar med Adobe IMS för att [!UICONTROL AEM as a Cloud Service]och hur Adobe IMS-användare [!UICONTROL User Groups]och [!UICONTROL Product Profiles] används för att kontrollera åtkomst till AEM och funktioner. |
...
| 17 augusti 2020 | [AEM användare, grupper och behörigheter](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/accessing/aem-users-groups-and-permissions.html) | Video | Adobe Experience Manager bygger vidare på Adobe IMS-användare, [!UICONTROL User Groups]och [!UICONTROL Product Profiles] för att ge anpassningsbar åtkomst till AEM. Lär dig hur du definierar AEM grupper och behörigheter och hur de fungerar tillsammans med Adobe IMS-abstraktioner för att ge smidig och anpassningsbar åtkomst till AEM. |
| 17 augusti 2020 | [Felsöka en Launch-implementering](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/integrations/experience-platform-launch/debug-launch-implementation.html) | Video | En introduktion till några vanliga verktyg och tekniker för att felsöka en Launch-implementering. Lär dig använda webbläsarens utvecklarkonsol och [!UICONTROL Experience Platform Debugger] tillägg för att identifiera och felsöka viktiga aspekter av en Experience Platform Launch-implementering. |
...
| 17 augusti 2020 | [Konfigurera AEM Assets för administratörer](https://video.tv.adobe.com/v/37647) | Video | I den här videon kan administratörer lära sig mer om konfigurering [!UICONTROL AEM Assets]. |
...
| [!UICONTROL Constraints] | Positionsbaserade begränsningar och begränsningsvillkor stöds inte längre: <br/> <ul><li>[!UICONTROL Min Pos] och [!UICONTROL Max Pos] begränsningar är inte längre tillgängliga och har tagits bort från alla tidigare skapade [!UICONTROL Bid & Position] begränsningar och [!UICONTROL Impression Share] begränsningar.</li><li>Befintlig [!UICONTROL Bid & Position] begränsningar som innehöll befattningsbegränsningar men inga anbudsbegränsningar pausades. De finns fortfarande i användargränssnittet och i rapporter.</li><li>[!UICONTROL Bid & Position] begränsningar har fått nytt namn [!UICONTROL Bid] begränsningar.</li><li>Alla positionsbaserade förhållanden (med [!UICONTROL Average Position], [!UICONTROL Weighted Average Position], eller [!UICONTROL Last Known Pos] mått) i alla typer av begränsningar togs bort.</li></ul> <br/> **Obs!** Positionsdata fylls i så länge de är tillgängliga från sökmotorerna. Microsoft Ads fasar ut positioner under september 2020. |
