...
Information om den senaste versionen finns i [Adobe-systemstatus - 21 maj 2020](https://experienceleague.corp.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html#status).

## ![Ikon](/assets/ec_appicon_24.png) Experience Cloud-gränssnitt {#ecloud}

I [Cumulative release notes](https://experienceleague.corp.adobe.com/docs/core-services/interface/release-notes/release-notes.html) finns den senaste versionsinformationen för Experience Cloud-gränssnittet (kundattribut, målgrupper, användar- och produktadministration).
...
* [Datavetenskapens arbetsyta](https://experienceleague.corp.adobe.com/docs/experience-platform/release-notes/latest.html#dsw)
* [Mål](https://experienceleague.corp.adobe.com/docs/experience-platform/release-notes/latest.html#destinations)
* [Källor](https://experienceleague.corp.adobe.com/docs/experience-platform/release-notes/latest.html#sources)
...
* Augustiversion - [Läs mer](https://experienceleague.corp.adobe.com/docs/journeys/using/release-notes/release-notes.html#august-release)
...
| ----------- | ---------- | ------- |
| [!UICONTROL Cross-Device Analytics]: Tillgänglighet i EMEA och APAC | 31 augusti 2020 | [Enhetsövergripande ](https://experienceleague.corp.adobe.com/docs/analytics/components/cda/overview.html) analyser och privata diagram är tillgängliga för kunder i EMEA och APAC. |
...
AEM 6.4, Service Pack 8, Cumulative Fix Pack 2 (6.4.8.2 släppt 3 september 2020) är en viktig uppdatering som innehåller flera interna korrigeringar och kundkorrigeringar sedan den allmänna tillgängligheten för AEM 6.4, Service Pack 8 (6.4.8.0), mars 2020.
   * [Versionsinformation](https://experienceleague.corp.adobe.com/docs/experience-manager-64/release-notes/cfp-release-notes.html)
...
* **[!UICONTROL AEM as a Cloud Service]**
   ...
   * Möjlighet i [!UICONTROL AEM as a Cloud Service] att [återställa sidor och undersidor (sidträd) till en tidigare version](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/sites/authoring/features/page-versions.html#reinstating-versions).
...
Se [Testning av innehållsgranskning.](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/test-results/content-audit-testing.html)
   ...
   * Se [AEM som en versionsinformation för Cloud Service.](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html)
...
* **Experience Manager  [!UICONTROL Desktop App] 2.0.3.2**
   ...
   * Se [versionsinformationen.](https://experienceleague.corp.adobe.com/docs/experience-manager-desktop-app/using/release-notes.html)
...
* **AEM[!UICONTROL Assets Brand Portal]**
   ...
   * Se [versionsinformationen.](https://experienceleague.corp.adobe.com/docs/experience-manager-brand-portal/using/introduction/brand-portal-release-notes.html)
...
* **Nya verktyg för[!UICONTROL AEM as a Cloud Service Transitions]**
   ...
   * [!UICONTROL AEM Dispatcher Converter] utökas med stöd för konverteringar av lokala  [!UICONTROL Managed Services Dispatcher] konfigurationer och Adobe till AEM som en Cloud Service-kompatibel Dispatcher-konfigurationer. Mer information finns i GitHub-resursen [AEM Cloud Service Dispatcher Converter](https://github.com/adobe/aem-cloud-service-source-migration/tree/master/packages/dispatcher-converter).
...
* **CDN Invalidation in[!UICONTROL Dynamic Media]**
   ...
   Mer information finns i [Cachevärdet för CDN har inte verifierats med hjälp av [!UICONTROL Dynamic Media].](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/assets/dynamicmedia/invalidate-cdn-cache-dynamic-media.html)
...
| 12 augusti 2020 | [Lokal utveckling med AEM som Cloud Service-SDK](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/commerce/develop.html) | Video | Lär dig hur du konfigurerar en lokal utvecklingsmiljö för [!UICONTROL AEM Commerce] och [!UICONTROL AEM as a Cloud Service] SDK. |
...
| 17 augusti 2020 | [Adobe IMS-användare](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/cloud-service/accessing/adobe-ims-users.html) | Video | Lär dig mer om vad Adobe IMS-användare är, hur de nås och hanteras i Admin Console och hur de kan användas för att logga in AEM som en Cloud Service. |
...
* Version 20.2.2 – [Läs mer](https://experienceleague.corp.adobe.com/docs/campaign-classic/using/release-notes/latest-release.html#release-20-2-2-build-9180)
