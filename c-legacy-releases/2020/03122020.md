...
| -----------| ---------- | ---------- |
| Beräkningen av första/sista besökssida har ändrats i Workspace | 7 april 2020 | Från om med mars 2020 i Analysis Workspace har vi ändrat hur värdet&quot;Inget&quot; interagerar med poster/utträden. Eftersom du nu kan aktivera och inaktivera&quot;Nones&quot; i Analysis Workspace, använder vi&quot;None&quot; (Ingen) efter inträde eller utträde, medan (för eVars) det tidigare användes. Anta till exempel att den första träffen av ett besök inte har något värde för eVarx, men att den andra träffen gör det. I Rapporter och Analytics visas det som &quot;Ospecificerad&quot; för bidraget, men i Analysis Workspace visas det som värdet för den andra träffen. |
...
* **AEM Assets varumärkesportal**
   ...
   AEM Assets Brand Portal 6.4, Service Pack 6 (6.4.6 släppt den 5 mars 2020) förändrar hur AEM Assets har konfigurerats med [!UICONTROL Brand Portal.] Dessutom innehåller versionen andra förbättringar och felkorrigeringar.
...
* **AEM som Cloud Service - Smart beskärning i Dynamic Media**
   ...
   **Aktivera matchning** av proportioner - Välj det här alternativet om du vill att Dynamic Media ska kunna välja en smart beskärningsåtergivning som bäst matchar originalbildens proportioner.
...
* **AEM SKill Builder-webbinarier**
   ...
   * AEM Sites - Med början den 17 mars 2020 får du lära dig grunderna och funktionerna för innehållsutveckling i AEM Sites. [Anmäl dig nu](https://aemskillbuilder-sites.experienceleague.adobeevents.com/register).
