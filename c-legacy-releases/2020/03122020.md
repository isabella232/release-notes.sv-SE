...
| [!DNL Adobe Campaign] | Självstudiekurs - [Push Notification with Android™](https://experienceleague.adobe.com/docs/campaign-standard-learn/getting-started-with-push-notifications-android/introduction.html?lang=sv) | Skicka personaliserade och segmenterade push-meddelanden till iOS- och Android™-mobilenheter. Den här självstudiekursen visar steg för steg hur du skickar push-meddelanden från Adobe Campaign och tar emot dessa meddelanden i Android™-appen. |
