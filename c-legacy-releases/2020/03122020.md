...
* **AEM Assets Brand Portal**
   ...
   AEM Assets Brand Portal 6.4, Service Pack 6 (6.4.6 släppt 5 mars 2020) ändrar hur AEM Assets konfigureras med [!UICONTROL Brand Portal.] Dessutom innehåller versionen andra förbättringar och felkorrigeringar.
...
* **AEM SKill Builder-webbinarier**
   ...
   * AEM Assets - Från och med 19 mars 2020 får du tips om grunderna i varumärkesportalen och mycket mer om digital resurshantering [!UICONTROL Dynamic Media,] [!UICONTROL Asset Link,] . [Anmäl dig nu](https://aemskillbuilder-assets.experienceleague.adobeevents.com/register).
...
* [Uppdatering för Campaign Classic 19.1.4](https://docs.adobe.com/content/help/sv-SE/campaign-classic/using/release-notes/previous-releases/release--19-1.html#release-19-1-4-build-9032)
...
| [!DNL Adobe Campaign] - Målgrupper | Video - [Create an audience...](https://docs.adobe.com/content/help/en/campaign-learn/campaign-standard-tutorials/profiles-and-audiences/audience-destinations/creating-audiences-using-segment-builder.html) | Skapa en målgrupp i Campaign Standard med Adobe [!UICONTROL Experience Platform Segment Builder]. Du kommer åt den här funktionen direkt inifrån Adobe Campaign Standard via [!UICONTROL Audiences] modulerna. |
...
| Adobe Analytics | Presentation - [Förstå kundreseanalys](https://docs.adobe.com/content/help/en/platform-learn/tutorials/cja/understanding-customer-journey-analytics.html) | Läs om hur Adobes [!UICONTROL Customer Journey Analytics], en applikationstjänst som bygger på [!DNL Adobe Experience Platform], kan integreras [!UICONTROL Analysis Workspace] i Experience Platform. Med den här funktionen kan du göra flerkanalsanalyser av alla dina [!DNL Adobe Experience Platform] datauppsättningar. |
