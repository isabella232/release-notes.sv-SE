...
## ![Gränssnittet](/assets/ec_appicon_24.png) i Icon Experience Cloud och bastjänsterna {#ecloud}
...
For product documentation, see [Experience Cloud](https://docs.adobe.com/content/help/sv-SE/core-services/interface/experience-cloud.html) help.
...
* **Analysis Workspace - mall** för självstudiekurser: Den här nya standardmallen leder dig igenom vanliga termer och steg för att skapa din första analys i Workspace. It is available as a standard template in the [!UICONTROL New Project] modal and replaces the sample project that exists today for new users that do not have other projects in their list.

#### Korrigeringar

* Ett problem som gjorde [!UICONTROL Reports & Analytics] att `.xls` rapporter inte kunde hämtas har åtgärdats. Detta problem påverkade kunder som använde andra valutor än dollar och euro. (AN-206541, AN-204008)
...
| Inställningen **[!UICONTROL Conversion Level]** tas bort | 3 mars 2020 | The non-functioning [Conversion Level](https://docs.adobe.com/content/help/sv-SE/analytics/admin/admin-tools/general-acct-settings-admin.html) setting in **[!UICONTROL Admin Tools]>[!UICONTROL Report Suites]>[!UICONTROL General Account Settings]** will be removed from the UI on March 12, 2020. |
...
* **AEM 6.5.4.0** AEM 6.5, Service Pack 4.0 (6.5.4.0 släppt 5 mars 2020) är en viktig uppdatering som innehåller nya funktioner, viktiga kundförbättringar, förbättrade prestanda, stabilitet och säkerhet som släppts sedan den allmänna tillgängligheten AEM 6.5 april 2019.
...
* **AEM Assets varumärkesportal**
   ...
   AEM Assets Brand Portal 6.4, Service Pack 6 (6.4.6 släppt 5 mars 2020) förändrar dessutom hur AEM Assets är konfigurerat med [!UICONTROL Brand Portal.] Dessutom innehåller versionen andra förbättringar och felkorrigeringar.
...
* **Konfigurera AEM Assets med varumärkesportalen**
   ...
   AEM Assets is now configured with [!UICONTROL Brand Portal] through Adobe I/O, which procures an IMS token for authorization of the Brand Portal tenant. Tidigare konfigurerades den i Classic-gränssnittet med hjälp av [!UICONTROL Legacy OAuth Gateway.]Se [Konfigurera AEM Assets med varumärkesportalen](https://docs.adobe.com/content/help/en/experience-manager-brand-portal/using/publish/configure-aem-assets-with-brand-portal.html).

* **AEM som Cloud Service - Smart beskärning i dynamiska media**

   Ett nytt alternativ är tillgängligt i AEM som Cloud Service när du arbetar med Smart beskärning i komponenten Dynamic Media:
...
* **Webbseminarier om AEM SKill Builder**
   ...
   * AEM Assets - Från och med 19 mars 2020 får du tips om grunderna i varumärkesportalen och mycket mer om hur du hanterar digitala resurser [!UICONTROL Dynamic Media,] [!UICONTROL Asset Link,] . [Anmäl dig nu](https://aemskillbuilder-assets.experienceleague.adobeevents.com/register).
...
| Visa | Funktion |
|------|---------|
| [!UICONTROL Portfolios] | Kontakta din kontoansvarige om du vill ha riktlinjer för hur du hanterar dina portföljer för att ta hänsyn till trafikförändringar som följer av [!DNL COVID-19]dem. |
| Google Ads och Microsoft Ads-kampanjer | I optimerade portföljer med [!UICONTROL Auto-optimize Bid Adjustment Values] alternativet optimerar inte längre Advertising Cloud automatiskt budjusteringsinställningarna för kampanjer med hjälp av den förbättrade eCPC-anbudsstrategin (cost per click). Sökmotorn optimerar alla offertjusteringar vid tidpunkten för auktionen. Advertising Cloud optimerar fortfarande basanbuden och - när alternativet är [!UICONTROL Auto adjust campaign budget limits] aktiverat - kampanjbudgeten. |
