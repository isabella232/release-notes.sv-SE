...
* [[!DNL Target]](https://experienceleague.corp.adobe.com/docs/target/using/release-notes/target-release-notes.html?lang=en) (länkar till Targets hjälpsida)
* [[!DNL Magento]](#magento)
* [[!DNL Marketo]](#marketo)
...
* [Customer Attributes har stöd för CCPA](https://experienceleague.corp.adobe.com/docs/core-services/interface/customer-attributes/ccpa.html) (California Consumer Privacy Act)
* [Customer Attributes har stöd för GDPR](https://experienceleague.corp.adobe.com/docs/core-services/interface/customer-attributes/gdpr.html) (allmänna dataskyddsförordningen)
...
* [Versionsinformation](https://experienceleague.corp.adobe.com/docs/journeys/using/release-notes/release-notes.html)
* [Instruktionsvideor](https://experienceleague.corp.adobe.com/docs/platform-learn/tutorials/journey-orchestration/introduction.html)
...
Se [Om spårning av spelartillstånd](https://experienceleague.corp.adobe.com/docs/media-analytics/using/player-state-tracking/player-state-overview.html).
...
Se [versionsinformationen om AppMeasurement för Javascript](https://experienceleague.corp.adobe.com/docs/analytics/implementation/appmeasurement-updates.html). Version 2.20.0 släpptes 5 mars 2020.
...
| [Tillägg för mörkt läge i Analysis Workspace](https://experienceleague.corp.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/customizing-the-ui/dark-mode-extension-for-analysis-workspace.html) | Aktivera Chrome-tillägget Dark Reader om du vill använda mörkt läge i Analysis Workspace. |
...
| [Användningsexempel för Audience Manager](https://experienceleague.corp.adobe.com/docs/audience-manager-learn/tutorials/intro-to-audience-manager/audience-manager-use-cases.html) | I den här videon ger vi exempel på fyra vanliga användningsområden för Audience Manager och beskriver de bästa metoderna. |
...
* **Bildformat som inte stöds i Dynamic Media**
   ...
   Se [Rastrerade bildformat som inte stöds i Dynamic Media](https://experienceleague.corp.adobe.com/docs/experience-manager-65/assets/administer/assets-formats.html#unsupported-image-formats-dynamic-media).
...
| [Mappscheman för metadata](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/assets/configuring/metadata-folder-schemas.html) | Med metadatamappscheman kan användare hantera och granska metadata som är kopplade till själva resursmapparna, i stället för direkt till resurser. |
| [Taggar](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/assets/configuring/tagging.html) | Taggar är ett viktigt verktyg för att hantera resurser i resursernas mapphierarki. Det är viktigt att skapa en taggningstaxonomi så att användarna kan identifiera och ordna resurser i AEM. |
...
| [Metadatascheman](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/assets/configuring/metadata-schemas.html) | Metadatascheman definierar gränssnittet som visar metadata för resurser i AEM. I den här videon beskriver vi metoder som kan kombineras när resurser används. |

### Ytterligare resurser

* [Versionsinformation för AEM as a Cloud Service](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html)
* [Dokumentation för AEM as a Cloud Service](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/landing/home.html)
...
* [AEM Cloud Manager – versionsinformation](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-manager/using/release-notes/release-notes-current.html)
...
* [Adobe Campaign Standard 20.3 version](https://experienceleague.corp.adobe.com/docs/campaign-standard/using/release-notes/release-notes.html)
...
| Innehåll | Beskrivning |
| -----------| ---------- |  
| [Big data-hantering i Snowflake](https://experienceleague.corp.adobe.com/docs/campaign-classic-learn/tutorials/administrating/fda/big-data-segmentation-on-snowflake.html) | Lär dig hur du kan utnyttja Snowflake-anslutningen i Adobe Campaign Classic. |
...
* Kontrollpanelen för Adobe Campaign: [Dokumentation](https://experienceleague.corp.adobe.com/docs/control-panel/using/control-panel-home.html) – [Versionsinformation](https://experienceleague.corp.adobe.com/docs/control-panel/using/release-notes.html) 
