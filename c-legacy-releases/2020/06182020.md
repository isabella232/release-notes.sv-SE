...
* **AEM as a Cloud Service**
   ...
   * Övergångsverktyg som stöder molnacceleration
   ...
   [Versionsinformation för AEM as a Cloud Service 2020.6.0](https://docs.adobe.com/content/help/sv-SE/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html)
...
* **Flytta till AEM as a Cloud Service**
   ...
   Ett av verktygen för kodkorrigering - AEM Dispatcher Converter släpptes. [AEM Dispatcher Converter](https://docs.adobe.com/content/help/sv-SE/experience-manager-cloud-service/moving/refactoring-tools/dispatcher-transformation-utility-tools.html) är ett verktyg för att konvertera befintliga AEM Dispatcher-konfigurationer till AEM as a Cloud Service Dispatcher-konfigurationer och är tillgängligt.
