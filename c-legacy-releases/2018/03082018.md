...
>[!NOTE]
>
>Om du vill få information om tidiga versionsinformation prenumererar du på [Adobe Priority-produktuppdateringen](https://www.adobe.com/subscription/priority-product-update.html). Prioriterad produktuppdatering publiceras tre till fem arbetsdagar före releasen. Kom tillbaka vid lanseringen för att se om det finns uppdateringar. Ny information som publiceras efter publiceringen markeras med publiceringsdatumet.

## Experience Cloud-profileringsuppdateringar

Gå [hit](https://marketing.adobe.com/resources/help/en_US/mcloud/solutions-core-services.html) för att lära dig mer om de senaste varumärkesuppdateringarna för lösningar och bastjänster i Experience Cloud.
...
<table id="table_E08D11345DD64677B46629651A0FFDBF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Adobe slutar att utfärda s_vi-cookies från tredje part för Safari </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>En ändring av sökfunktionen (back-end) kommer att påverka rapporteringen på flera sätt. Observera att dessa ändringar trädde i kraft i <b>slutet av februari 2018</b>: </p> 
    <ul id="ul_7515E2E79FD94B8F8DFF4C2DBB9E6A84"> 
     ...
     <li id="li_14CAB45EC2F2490BB6C8A912C66BB77C"> URL-ersättningsmetoden är annorlunda. Tidigare lagrar Adobe Analytics (till största delen) den första URL som är kopplad till varje sidnamn varje månad. Vi kommer att lagra den senaste URL:en för varje sidnamn. </li> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nu kan du radbryta rubriktexten i frihandstabeller för att göra rubrikerna mer läsbara och lättare att dela. Vi har lagt till <span class="uicontrol"> Radbryt rubriktext </span> i kolumninställningarna. Det här alternativet är särskilt användbart för <span class="filepath"> .pdf- </span> återgivning och för mått med långa namn. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   ...
   <td colname="col2"> <p>För att det ska bli enklare att snabbt skapa beräknade mått <span class="uicontrol"> </span> har Skapa mått från markering lagts till på högerklicksmenyn. Det här alternativet visas när en eller flera rubrikkolumnceller är markerade. </p> 
    <!--<p>More… </p>--> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/map-visualization.html" format="html" scope="external"> Förbättringar av kartvisualisering </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>För de senast släppta anpassade mallarna </p> 
    <ul id="ul_787F48253F454163B99F6DD50F199FE2"> 
     ...
     <li id="li_EEAA4D115CB74A57BABD524B2561E0CC">Tillåt icke-administratörer att skapa (spara som) och redigera projektmallar för arbetsytan, förutsatt att de har beviljats <span class="uicontrol"> behörigheten Skapa/välj projekt i [!UICONTROL Analysis Workspace] </span> . ( <span class="ignoretag"><span class="uicontrol"> Admin </span> &gt; <span class="uicontrol"> Användarhantering </span> &gt; <span class="uicontrol"> Grupper </span> &gt; <span class="uicontrol"> Redigera all rapportåtkomst </span> <span class="uicontrol"> </span> <span class="uicontrol"> </span> </span>&gt; Anpassa analysverktyg &gt; Skapa/Kuratera projekt i [!UICONTROL Analysis Workspace]¥). </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td> <p>Virtuella rapportsviter </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
  ...
  <tr> 
   <td colname="col01"> <p>Beräknade mått </p> </td> 
   ...
   <td colname="col2"> <p>Adobe Analytics Select-kunder har nu rätt att använda avancerade beräknade mätvärden. </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_B3810CF9DA584DDDB811F1D0F91B78F2"> 
      ...
      <li id="li_A1730CAFC666475B957AFB7821F53CB6"> <b>Användarmigrering</b>: Ett felmeddelande om användarmigrering har åtgärdats som förklarar att användargränssnittet i Experience Cloud inte tillåter vissa specialtecken i användarnamn. (AN-155946) </li> 
...
* Korrigerade ett fel på Audience Marketplace där den vågräta rullningen inte skulle fungera i modal View All Traits (Visa alla traits), så att kunderna inte kunde utforska egenskaper med längre namn. (AAM-34033)
...
* Korrigerade ett fel i Audience Lab, där en kund råkade klicka på **[!UICONTROL Slutför kontrollgrupp]** två gånger för att skapa en dubblettkontrollgrupp. (AAM-31141)
...
* Korrigerade ett fel i inställningarna för datakälla där alternativknapparna återställdes till **[!UICONTROL Kund-ID]** med alla andra val på sidan. Den här korrigeringen innehåller även vissa felmeddelandeinkonsekvenser för inställningarna för datakälla. (AAM-34754)
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>AEM Assets Brand Portal 6.3.2, som släpptes den 13 februari 2018, innehåller nya och förbättrade funktioner som är inriktade på kundförfrågningar och allmänna prestandaförbättringar. Dokumentationen innehåller följande viktiga uppdateringar: </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>AEM-versioner och uppdateringar </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>AEM 6.2 SP1-CFP12 (6.2.1.12), släppt 13 februari 2018, är en viktig uppdatering som innehåller viktiga kundkorrigeringar som släppts sedan den allmänna tillgängligheten av AEM 6.2 SP1, december 2016. </p> <p> 
     <ul id="ul_C31EAB4DC0AB4289B5C2B5B08CBFEE84"> 
      ...
      <li id="li_81055178B5F448AAB30CB44E67001317"> <a href="https://helpx.adobe.com/aem-forms/kb/aem-forms-releases.html" format="https" scope="external"> AEM Forms CFP-releaser </a> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1" morerows="3"> <p> <b>Självhjälp</b> </p> </td> 
   <td colname="col2"> <p>Integrering av AEM Forms-data </p> </td> 
  ...
  <tr> 
   <td colname="col2"> <p> Konvertera HTML till PDF med AEM Forms med PDF Generator </p> </td> 
  ...
  <tr> 
   <td colname="col2"> <p>Integrering med Adobe Analytics </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> Få insikter i Nyheter i AEM 6.4. Läs mer om det webbinarium om AEM 6.4 som presenterats av Loni Stark och Cedric Huesler. Du kan spela upp sessionen <a href="https://helpx.adobe.com/experience-manager/kt/eseminars/experience-insider/whats-new-aem-6_4.html?cq_ck=1519347337985" format="https" scope="external"> här </a>. </p> <p>Håll utkik efter AEM GEMS kommande djupdykning i de senaste uppdateringarna. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Vyn med tidigare kampanjer (betaversion) är nu den primära vyn för kampanjer för skrivskyddade användare. Den äldre vyn är fortfarande tillgänglig på Campaigns (äldre). </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
