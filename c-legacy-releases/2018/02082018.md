...
* Korrigerade ett problem med [!DNL Audience Manager] trait som gjorde att segment som skapats via målgruppsbibliotekets gränssnitt inte fylldes i med data [!DNL Audience Manager]. (CORE-9891)
* Korrigerade ett problem som gjorde att tillgångsväljaren kunde användas på hybridenheter med pekskärmar. (CORE-9932)
* Tillagt granskarkort i aktiveringsgränssnittet för de tilldelade användarna. (CORE-3667)Produkthjälp finns i [produktdokumentationen](https://docs.adobe.com/content/help/en/core-services/interface/about-core-services/core-services-landing.html) för Experience Cloud.
...
* [Viktiga meddelanden för analytiska administratörer](../../c-legacy-releases/2018/02082018.md#analytics_notices) (uppdaterad **02/08/2018**)
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Anpassade arbetsytemallar </p> </td> 
   <td colname="col2"> <p>Nu kan du skapa egna arbetsytemallar och spara dem så att andra användare i organisationen kan börja med data som är relevanta för dem. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/starter_projects.html" format="html" scope="external"> Mer ... </a></p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Ny startspärr för projekt </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Vi har lagt till ett högerklicksalternativ,"Kopiera till Urklipp", så att du kan kopiera celler/tabeller på ett konsekvent sätt. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/t_freeform_project.html" format="html" scope="external"> Mer ... </a></p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Förbättring av kolumn % </p> </td> 
   <td colname="col2"> <p>Procentandelen av totalen som visas i kolumner begränsades till 100 %, även när vissa scenarier leder till att rader är mer än 100 % av totalsumman (till exempel med medelvärden). </p> <p>Vi visar nu procenttal som är större än 100 %, för att vara mer korrekta. Vi flyttar också det övre gränsvärdet till 1 000 % för att säkerställa att kolumnerna blir för stora. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/column-settings.html" format="html" scope="external"> Mer ... </a></p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Villkorsstyrd formatering aktiverad för uppdelningar </p> </td> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Ändringar i standardkalendervyn </p> </td> 
   <td colname="col2"> <p>Som standard visas den aktuella månaden och den sista månaden i arbetsytekalendern, i stället för den aktuella månaden och nästa månad. <a href="https://marketing.adobe.com/resources/help/en_US/analytics/analysis-workspace/calendar.html" format="html" scope="external"> Mer ... </a></p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_2F22339DDE4C475F89B53D0E6FF33183"> 
      ...
      <li id="li_7AB00F90761A49C8B3C02E30494622D1">Ett problem har korrigerats där användaren skulle hamna på sidan [!UICONTROL Analysis Workspace] Overview i stället för på det delade projektet när användaren klickade på länken Delat projekt. (AN-152917) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_B3810CF9DA584DDDB811F1D0F91B78F2"> 
      ...
      <li id="li_70C87228892242C99129CF1625A88B24"> <b>Varningar</b>: Korrigerade ett problem som uppstod när ett <span class="wintitle"> </span> radobjekt av typen Ingen markerades i [!UICONTROL Analysis Workspace] och högerklickades på Skapa en varning från markering. Varningsbyggaren innehöll endast"ospecificerad" som ett alternativ, men inte"Ingen". Om du fortsätter visas "Ospecificerad" i [!UICONTROL Analysis Workspace]. (AN-146879) </li> 
...
* Korrigerade ett fel i Internet Explorer 11 där kunderna inte kunde skapa nya segmenttestgrupper i Audience Lab eftersom knappen **[!UICONTROL Next]** (Nästa) saknades. (AAM-34503)
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Referenshandboken för <a href="https://helpx.adobe.com/experience-manager/6-3/sites/developing/using/querybuilder-predicate-reference.html" format="https" scope="external"> AEM Query Builder </a> är nu tillgänglig. Dokumentationen innehåller alla inbyggda produktpredikatorer. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Adobe IMMERSE'18 infaller 12-14 juni 2018 i IST, BST och PDT med 8 sessioner varje dag. </p> <p>Sista ansökningsdatum har förlängts till måndagen den 5 februari 2018. 
     <ul id="ul_F57E78C4746D42AD98330498F3A01DA0"> 
      <li id="li_01D4D267E35148068613B42FB25BD31E"> <a href="https://immerse18.adobe-devs.adobeevents.com/speaker-application/" format="https" scope="external"> Anrop till presentationsinformation och inlämningsformulär </a></li> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Onsdagen den 7 februari 2018 kl. 8.00-9.00 PST </p> <p>Träffa Matt Ryan, Senior Software Engineer på Adobe, som delar med sig av resultaten från <i>Experiments i AEM Author Scalability</i>. </p> <p>Anmäl dig till sessionen <a href="https://helpx.adobe.com/experience-manager/kt/eseminars/gems/aem-author-scalability.html?cq_ck=1516987340995" format="https" scope="external"> här </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>On demand-sessioner </p> </td> 
   <td colname="col3"> <p>Nu kan du hitta alla webbinarier för företagsutvecklare på AEM HelpX Forum. Bokmärk följande länkar: </p> <p> 
     <ul id="ul_10C986E4FC2F417C9AEA1DA6E0E4CA91"> 
      ...
      <li id="li_82D67EBD4DF74A86A14E97BE98BBB558"> <a href="https://helpx.adobe.com/experience-manager/kt/eseminars/ask-the-expert/atace-index.html" format="https" scope="external"> Fråga AEM Community Expert </a> fördjupa sig i ämnen som behandlas i HelpX Forum. </li> 
      <li id="li_BF54BEF7E269407A982CD7E1CFE6DCC0">Våra <a href="https://helpx.adobe.com/experience-manager/kt/eseminars/ccoo-index.html" format="https" scope="external"> Adobe Customer Care Office-timmar </a>; Adobes experter delar med sig av sina erfarenheter av kundimplementeringar över hela världen. </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Mer information finns i produkten om du klickar på hjälpikonen:  **[!UICONTROL ?]** > **[!UICONTROL Hjälpinnehåll]** .
