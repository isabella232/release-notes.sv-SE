  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_36A11615EEA34624AF7E422036B80723"> 
      ...
      <li id="li_CDDB0F0927B349DD9653F6B47EF57471"> Ett nytt API har lagts till: <span class="codeph"> "retrievethenRemoveIdentities" </span> som ska användas om du vill skicka en GDPR-begäran för att få tillgång till och ta bort data. Detta API ställer in åtgärdsegenskapen på <span class="codeph"> ["access", "delete"] </span> </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Hur man skickar GDPR-förfrågningar till <span class="wintitle"> Audience Manager </span>och hur man besvarar vanliga frågor om hur Audience Manager uppfyller GDPR-kraven. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> Datan Workbench stöder GDPR-processer för att anonymisera personidentifieringsinformation. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Med Advertising Analytics kan du skicka sökmotordata till Adobe Analytics från Google AdWords, Yahoo! och Bing. </p> <p>Du har tillgång till följande mätvärden för att kunna utföra rapportering sida vid sida med resten av dina Analytics-data: </p> 
    ...
    <ul id="ul_D92898E28FEB4ADAB68869B3276182A9"> 
     ...
     <li id="li_D0C425C5C99C4097B9465BB656872914">Annonsplattform (AMO ID) </li> 
    ...
    </ul> <p><b>Obs!</b> Advertising Analytics finns för kunder på Select, Prime eller Ultimate SKU. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Analytics Connector finns som intern dataanslutning i Power BI Desktop Experience. När du startar programmet kan du autentisera med din befintliga Adobe ID. Du kan sedan komma åt en lättanvänd navigator till elementen i rapportsviten och skapa dataförfrågningar. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="uicontrol"> Analysis Workspace- </span> förbättringar </p> </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>Planerad release från 15 maj 2018</b> </p> <p> <span class="term"> mc_audiences- </span> kolumnen har lagts till. <span class="term"> mc_audiences </span> är Audience Analytics segment-ID-listan från Adobe <span class="wintitle"> Audience Manager </span>. </p> <p>Obs!  Detta inkluderar inte egna namn eftersom de är en klassificering av ID:t. </p> 
    <!--<p>https://jira.corp.adobe.com/browse/AN-154807</p>--> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Länderrapport i Ad Hoc Analysis </p> </td> 
   <td colname="col2"> <p>Länderrapporten i Ad Hoc Analysis har bytt namn till Länder/regioner. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_A50A05631E574C83AD7075579B14ACF1"> 
      <li id="li_227327CC9233438688BF7F593027C1DE">Korrigerade ett fel som uppstod när verktyget för beräknade mått öppnades från [!UICONTROL Analysis Workspace]. Detta gjorde att listrutan Funktion inte visade några alternativ. (AN-160698) </li> 
      ...
      <li id="li_DCFFC6CB25054530B5B8B0418DB5CC36">Korrigerade ett problem som gjorde att textvisualiseringar standardinställdes på sidans överkant och förhindrade att de placerades på önskad plats. (AN-159148) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_666BB742E5BE4CC9BE95E697DA5DBB67"> 
      <li id="li_6B5F531B822D4392AD7760752C29B371">Korrigerade ett fel i segmentbyggaren, där etiketterna på alternativen Endast före sekvens och Endast efter sekvens ändrades och nu har återställts. (AN-160747) </li> 
      ...
      <li id="li_E2A3A073962847FE98D3866E97B6EF04">Ett problem som uppstod vid inloggning på Analytics via Experience Cloud har korrigerats: när flera inloggningsföretag var kopplade till ett användarnamn, valdes ibland ett felaktigt inloggningsföretag. (AN-160880) </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Vi har släppt DIL version 7.0 som innehåller följande uppgraderingar och korrigeringar: </p> <p> 
     <ul id="ul_D127326A5EA14C028D43A62CAA8CD758"> 
      <li id="li_FDBFB52DA5214B50B3D77482925B8FA4">Ett tävlingsvillkor i Launch med modulen <a href="https://marketing.adobe.com/resources/help/en_US/aam/r_dil_sc_init.html" format="html" scope="external"> DIL SiteCatalyst har korrigerats </a>. (CORE-10266) </li> 
  ...
  <tr> 
   <td colname="col1"> <p>GDPR-efterlevnad </p> </td> 
   <td colname="col2"> <p>När vi närmar oss den 25 maj, 2018 då den europeiska allmänna dataskyddsförordningen (GDPR) trädde i kraft, har vi förberett dokumentation som hjälper er att hantera konsumentdata i <span class="wintitle"> Audience Manager för att uppfylla GDPR-skyldigheterna </span> . Läs vidare: </p> <p> 
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>AEM smarta anpassade taggar 2.1 </p> </td> 
  ...
  <tr> 
   <td colname="col2"> <p>Omstrukturering av lager i AEM 6.4 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Den årliga virtuella globala konferensen ger djupgående sessioner för företagsutvecklare, arkitekter och datavetare på alla erfarenhetsnivåer. Live-sessioner hålls i tidzonerna Indien Standard, British Sommar och Pacific. Biljettinnehavare har också obegränsad tillgång till alla inspelningar under ett år. </p> <p>Adobe IMMERSE är den årliga virtuella globala konferensen för alla utvecklare som bygger lösningar på Adobe Experience Manager. I år har vi även andra seminarier om Adobe Cloud Platform, Adobe i/O, Adobe Sensei, ColdFusion och FrameMaker. </p> <p>Få djupgående produktintroduktioner, recept på hur man gör, metodtips och kodexempel från experter i Adobe och en bredare utvecklarcommunity. Live-sessioner kommer att sändas över tre tidszoner: </p> <p> 
     ...
     </ul> </p> <p>Se vad som står på dagordningen och registrera dig för <b>MR.765z</b> för en rabatt på 25,00 USD - till följande pris: <a href="https://adobe.ly/immerse18" format="https" scope="external"> https://adobe.ly/immerse18 </a>. Missa inte den största utvecklarkonferensen på Adobe! </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>AEM Technologist Meetup Group </p> </td> 
   <td colname="col3"> <p>Den här virtuella gruppen ger dig meddelanden om AEM GEM:er, fråga webbinarierna AEM Community Expert så snart de är schemalagda. Du får även meddelanden om personliga möten och regionala användargruppmöten. </p> <p> Gå med på följande: <a href="https://adobe.ly/2sVoSwy" format="https" scope="external"> https://adobe.ly/2sVoSwy </a> </p> </td> 
  </tr> 
  <tr> 
