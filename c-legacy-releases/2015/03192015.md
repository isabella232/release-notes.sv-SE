...
* Ett problem har korrigerats där användaren inte kunde logga in som en annan användare med [!UICONTROL Sign in with Adobe ID] inloggningsalternativet. Användare kan klicka [!UICONTROL Sign in with a Different Adobe ID] för att logga ut som den aktuella [!DNL  Marketing Cloud] användaren och omdirigeras till inloggningssidan för Adobe.
