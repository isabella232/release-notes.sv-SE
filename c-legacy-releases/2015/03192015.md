...
<table id="table_371D2B21B8EF411FA2DD33DD585F1F8F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Avsnittet <a href="https://docs.adobe.com/content/help/sv-SE/core-services/interface/experience-cloud.html" format="https" scope="external"> Core Services - Enabling Your Solutions </a> to assist you with implement core services har lagts till. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_03055471A9624B40B122C0E2CD295AA9"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> </p> </td> 
   <td colname="col2"> <p>Om du har flera <span class="wintitle"> Analytics- </span> företag kan du växla mellan dem i Mobiltjänster när du loggar in på Mobile Services med din Adobe ID. </p> <p>Om du vill ändra företag klickar du på användarikonen i det övre högra hörnet i sidhuvudet. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Ett problem har korrigerats där alternativet [!UICONTROL  Store Path] för FTP-biblioteksdistributioner inte uppdaterades för produktionsbibliotek när kapslade kataloger användes.
* Uppdaterade dataelement som stöder avstavade namn.
* Ett problem har korrigerats där kolumnindikatorn i [!UICONTROL  Rules] tabellen som visas för en regel, även om verktyget har tagits bort.
* Kodalternativet är bara tillgängligt för sidinläsningsregler uppdaterat [!UICONTROL  Sequential HTML] . Det här alternativet visas inte längre för händelsebaserade regler. Ett meddelande visas med en [!UICONTROL  Sequential HTML] tagg i en händelsebaserad regel för att meddela användarna att de ska ändra taggen innan regeln kan sparas.
* Ett problem har korrigerats där användaren inte kunde logga in som en annan användare med [!UICONTROL  Sign in with Adobe ID] inloggningsalternativet. Användare kan klicka för [!UICONTROL  Sign in with a Different Adobe ID] att logga ut som den aktuella [!DNL  Marketing Cloud] användaren och omdirigeras till inloggningssidan för Adobe.
...
### Nya funktioner, förbättringar eller ändringar i [!DNL Analytics] {#features_analytics}
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="uicontrol"> Besöksprofil </span> &gt; <span class="uicontrol"> Kundattribut </span>. </p> <p>Om du samlar in data om företagskunder i en CRM-databas (customer relationship management) kan du överföra dessa data till en datakälla för kundattribut i Marketing Cloud. När data har överförts kan du köra kundattributrapporten i rapporter och analyser. <a href="https://docs.adobe.com/content/help/sv-SE/core-services/interface/customer-attributes/attributes.html" format="https" scope="external"> Mer... </a></p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> Kalenderhändelser som har markerats som Delade har nu ett alternativ för att skicka kalenderhändelsen till andra användare. När du pushar en kalenderhändelse visas den i mottagarens diagram över trender och över tid. Det gör kalenderhändelser mer användbara. Nu kan analytiker tvinga fram en överlagring på användarnas rapporter för att få mer kontext. </td> 
  </tr> 
  <tr> 
...
* Ett problem har korrigerats där kryssrutan i **[!UICONTROL  Select All]** **[!UICONTROL  Segment Manager]** markerade fler segment än vad som förväntades när ett filter användes. Nu markeras bara de synliga, aktiva segmenten.
* Korrigerade ett problem där en brytning av [!UICONTROL  Servers] rapporten *`Site Sections`* eller *`Page Names`* returnerade en [!UICONTROL  Top Level Domains] rapport istället.
...
* Ett problem har korrigerats där Adobe avsändardomän (omniture.com) inte matchade *`From`* värdet (adobe.com) i e-postmeddelanden om lösenordsåterställning. Detta ledde till att dessa e-postmeddelanden blockerades och aldrig togs emot av användaren. Värdet *`From`* har ändrats till [!DNL  httpd@omniture.com].

### Report Builder {#fixes_arb}

**Korrigeringar**

* Ett problem har korrigerats där Visits-måttet inte visades i [!UICONTROL  Available Metric] listan på andra sidan av [!UICONTROL  Request Wizard] Report Builder.
...
* Ett problem har korrigerats där data warehouse-rapporter inte kunde levereras när e-postadressen angavs som klientföretagets e-postadress i fältet Från. Alla rapporter från data warehouse skickas nu från [!DNL  no-reply@omniture.com].
...
På sidan [Adobe Target Release Notes](https://docs.adobe.com/content/help/en/target/using/release-notes/release-notes.html) finns den senaste versionsinformationen om följande produkter:
