---
description: Nytt i Analytics Analysis Workspace-förbättringar och tidsstämplar (valfritt). Grupphantering inom dynamisk tagghantering. Mobila push-meddelanden till Analytics-segment, förvärvsmetoder och postback-signaler. Allmänna korrigeringar och förbättringar av lösningar från Marketing Cloud.
keywords: release notes
seo-description: Nytt i Analytics Analysis Workspace-förbättringar och tidsstämplar (valfritt). Grupphantering inom dynamisk tagghantering. Mobila push-meddelanden till Analytics-segment, förvärvsmetoder och postback-signaler. Allmänna korrigeringar och förbättringar av lösningar från Marketing Cloud.
...
Nytt i Analytics: Analysis Workspace-förbättringar och tidsstämplar är valfria. Grupphantering inom dynamisk tagghantering. Mobila push-meddelanden till Analytics-segment, förvärvsmetoder och postback-signaler. Allmänna korrigeringar och förbättringar av lösningar från Marketing Cloud.
...
* [Målgrupp](../../c-legacy-releases/2015/09172015.md#target)
...
* [Marketing Cloud](../../c-legacy-releases/2015/09172015.md#marketing_cloud_interface)
...
Lösningsadministratörer kan läsa [Användare och grupper](https://marketing.adobe.com/resources/help/en_US/mcloud/user_mgmt_admin.html) för att få viktig information om hur du mappar lösningsgrupper till större Adobe-grupper och lägger till användare i [Enterprise Dashboard](http://adminconsole.adobe.html/#).

**Korrigeringar**

* Korrigerade ett prestandaproblem för Audience Manager API som orsakade intermittenta timeout vid överföring av kundattributdata. (MAC-26305)
...
**SDK-uppdateringar för Adobe Mobile Services**
...
<table id="table_812AC7BF7F314540B7DA72D1C97D1918"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>Universell Windows Platform SDK 4.x för Marketing Cloud Solutions </p> </td> 
   <td colname="col2"> <p>UWP (Universal Windows Platform) SDK 4.x för Marketing Cloud Solutions finns nu att köpa. </p> <p>Med detta nya SDK kan ni mäta inbyggda Windows 10-program, leverera riktat innehåll i appen och utnyttja och samla in målgruppsdata via Audience Manager. </p> <p>Se <a href="https://marketing.adobe.com/resources/help/en_US/mobile/uwp/" format="https" scope="external"> Universal Windows Platform SDK 4.x för Marketing Cloud Solutions </a>. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Version 4.6 av båda SDK:erna (Android och iOS) är nu tillgängliga. </p> <p>Båda SDK:erna innehåller följande förbättringar: </p> <p> <b>Push-meddelanden till analyssegment: </b> <span class="keyword"> Med Adobe Mobile Services </span> och <span class="keyword"> Adobe Mobile </span> SDK kan du skicka push-meddelanden till <span class="wintitle"> Analytics- </span> segment. Med SDK kan du även enkelt rapportera användare som har öppnat din app som ett resultat av att push-meddelandet har öppnats. </p> <p> <b>Anskaffningsmetoder: </b>Tillåter utvecklare att starta en app-anskaffningskampanj som om användaren hade klickat på en länk. Detta är praktiskt när du vill skapa länkar för manuell hämtning och hantera omdirigering av appbutiken själv. </p> <p> <b>Återanslående: </b>Tack vare återkopplingar kan du skicka data som samlats in av SDK till en separat tredjepartsserver. Genom att utnyttja samma utlösare och egenskaper som du använder för att visa ett meddelande i appen kan du konfigurera SDK:n så att anpassade data skickas till en tredjepartsdestination. </p> <p> <b>Identifierare: </b>Följande nya identifierare har lagts till: </p> 
    ...
    </ul> <p> <b>WatchKit-stöd för WatchOS 2 (endast iOS SDK): </b>Stöd för WatchKit har lagts till för WatchOS 2. </p> <p>Mer information finns i: 
...
**Uppdatering av tjänstverktyget för Marketing Cloud Visitor ID:** Den 22 september kommer DTM att släppa en uppdatering av verktyget Marketing Cloud Visitor ID Service. Den senaste biblioteksversionen (1.6.1) ger förbättrat stöd för kund-ID, utökat stöd för autentiserat läge och förbättrad integration med flera lösningar.

Den senaste versionen är helt kompatibel med aktuella distributioner av Marketing Cloud Visitor ID-tjänsten via DTM. För att alla användare ska kunna dra nytta av den här uppdateringen migreras ditt konto automatiskt till det nya Marketing Cloud ID-tjänstbiblioteket.
...
DTM-teamet strävar efter att tillföra värde till våra kunder, och vi är säkra på att du kommer att se detta i uppdateringen av verktyget Marketing Cloud Visitor ID Service.

**Borttagning av Amazon S3:** Adobe har ersatt användningen av Amazon S3 som värdalternativ för DTM-bibliotek.

Adobe stöder inte längre Amazon S3. Dina bibliotek för dynamisk tagghantering i Amazon S3 kommer att fortsätta att användas till och med den 31 december 2015, men i ett skrivskyddat läge. Ändringar som görs i den dynamiska tagghanteringen återspeglas inte längre i dessa filer.
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b>Federated Analytics: </b> <span class="wintitle"> Federated Analytics </span> är en <span class="keyword"> Adobe Video Analytics- </span> funktion som möjliggör standardiserad delning av videodata mellan olika plattformar, enligt regler/logik, mellan partners. Delaren <span class="term"> </span> kan styra data, ned till en enskild videonivå, som ska delas under varje videouppspelning. Mottagaren <span class="term"> </span> kan ange var data ska skickas, inom Adobe, baserat på definierade utlösare. </p> <p>Se <a href="https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/hbvideo/federated-analytics.html" format="https" scope="external"> Federated Analytics </a>. </p> <p> <b>OTT-analys (over-the-top): </b> <span class="keyword"> Adobe Video Analytics </span> ger standardiserad mätning av både video och appar för OTT-enheter. Nya SDK:er för OTT: </p> 
    <ul id="ul_638BAF5CFEEA41BB81EB7BA407C67DA2"> 
     <li id="li_7F78058588C349ABA643A449286A6197">Roku (endast BrightScript-program) </li> 
    ...
    </ul> <p>Se <a href="https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/hbvideo/ott_analytics.html" format="https" scope="external"> OTT-analys (over-the-top) </a>. </p> <p> <b>Mätvärden för upplevelsekvalitet: </b>Adobe Video Analytics <span class="keyword"> SDK samlar in ungefär 20 </span> kvalitetsmätningar <span class="wintitle"> </span> för upplevelse, inklusive buffring, bithastigheter och fel för att spåra hur videokvaliteten påverkar viktiga interaktionsmått som hur länge de används, videor per besök, annonser per video och så vidare. </p> <p>Se <a href="https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/hbvideo/c_quality_variables_events.html" format="https" scope="external"> Kvalitetsvariabler och -händelser </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Data Workbench 6.5 </td> 
   <td colname="col2"> En ny Associations Table och andra funktioner som lagts till i den nya <a href="https://marketing.adobe.com/resources/help/en_US/insight/whatsnew/c_6_5_.html" format="https" scope="external"> Datan Workbench 6.5 </a>. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Förbättring av data warehouse </td> 
   <td colname="col2"> <p>Ett kryssrutealternativ har lagts till i användargränssnittet för Data warehouse där du kan"Sortera utdata efter mätvärden". </p> <p>Om du markerar den här rutan sorteras utdata baserat på måttkolumnernas ordning som valts i rapportförhandsvisningen. Mätvärdena sorteras i fallande ordning. <a href="https://marketing.adobe.com/resources/help/en_US/reference/sorting-by-metric.html" format="https" scope="external"> Mer ... </a> (AN-100771) </p> </td> 
  </tr> 
  <tr> 
...
Analysadministratörer: Om du är administratör i Marketing Cloud går du till [Användare och grupper](https://marketing.adobe.com/resources/help/en_US/mcloud/user_mgmt_admin.html) för att få uppdaterad information om hur du mappar Analytics-grupper till bredare Adobe-grupper och lägger till användare i [Enterprise Dashboard](http://adminconsole.adobe.html/#).
...
* Ett problem som gjorde att anpassade eVars inte kunde visas på [!UICONTROL Reports] menyn har korrigerats. (AN-107387)
* Ett problem har korrigerats där ett diagram i en PDF-hämtad [!UICONTROL Targets] rapport inte matchade diagrammet i webbgränssnittet. (AN-107389)
...
* Korrigerade ett [!UICONTROL Audience Marketplace] fel som gav dubbel inventerad intäkt i [!UICONTROL My Shared Data] listan. (AAM-20200, AAM-20852)
* Korrigerade ett [!UICONTROL Audience Marketplace] fel som felaktigt visade en varningssymbol för&quot;ingen användning&quot; för dataflödesprenumerationer med schablonavgift. (AAM-20850)
* Korrigerade en felstavad etikett på [!UICONTROL Create a Profile Merge Rule] sidan. (AAM-20920)
* Ett fel som gjorde att du inte kunde hämta rapporter i CSV-format har korrigerats. (AAM-20940, AAM-20839)
* I avsnittet [!UICONTROL Formats] i det interna administrationsverktyget ökade antalet tecken i dataradsfältet till > 255 tecken. (AAM-20768)

**Ny och reviderad dokumentation**

* I den nya dokumentationen beskrivs hur du använder metadatafiler för att ersätta numeriska ID:n med läsbar text i [!UICONTROL Advertising Analytics] rapporterna. Se [Data- och metadatafiler för Advertising Analytics-rapporter](https://marketing.adobe.com/resources/help/en_US/aam/metadata-files-intro.html).
* Reviderad [hämtning av data för kampanjdatainpressning via pixelanrop](https://marketing.adobe.com/resources/help/en_US/aam/c_capturing_camp_data.html) för att inkludera nya nyckelvärdepar som krävs för [!UICONTROL Advertising Analytics] rapporterna.
* Reviderad [Capturing Campaign Click Data via Pixel Call](https://marketing.adobe.com/resources/help/en_US/aam/c_capturing_camp_click_data.html) för att inkludera nya nyckelvärdepar som krävs av Advertising Analytics-rapporterna.
...
* Korrigerade ett problem som förhindrade användare från att ta bort väntande tweets i [!UICONTROL Content Calendar].
...
* Klassiskt mål
* Recommendations ClassicAdvertising Management help is available in the product at **[!UICONTROL Help > Help Contents]**.
