...
keywords: 'Versionsinformation om '
...
>[!NOTE]
>
>Om du vill få versionsinformation en vecka före den månatliga produktuppdateringen prenumererar du på [produktuppdateringen Adobe Priority](https://www.adobe.com/subscription/priority-product-update.html). Versionsinformation i Priority Product Update kommer en vecka före releasedatum och kan komma att ändras. Kom tillbaka vid lanseringen för att se om det finns uppdateringar.

## Centrala tjänster

### Marketing Cloud Interface 15.5.1 {#marketing_cloud_interface}

Nya funktioner och korrigeringar i gränssnittet [!DNL  Adobe Marketing Cloud].
...
* Menyvalen <span class="term"> Målgruppsbibliotek </span> och <span class="term"> Kundattribut </span> finns nu under <span class="term"> Målgrupper</span>.
* Menyvalet <span class="term"> Exchange </span> har flyttats från den nedrullningsbara menyn Hjälp till den vänstra navigeringslisten.
...
* Ett problem som gjorde att [Adobe Target produktdokumentation](https://marketing.adobe.com/resources/help/ja_JP/target/a4t/) inte kunde visas på japanska har åtgärdats.
* Ett problem som förhindrade användning av japansk text i kommentarer mellan [!DNL  Creative Cloud] och [!DNL  Marketing Cloud] har åtgärdats.

Mer information finns i [produktdokumentation för Marketing Cloud](https://docs.adobe.com/content/help/en/core-services/interface/about-core-services/core-services-landing.html).

### Adobe Mobile Services {#mobile}

Nya funktioner och korrigeringar i gränssnittet [!DNL  Adobe Mobile Services].
...
<table id="table_03055471A9624B40B122C0E2CD295AA9"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>PDF/CSV-export för <span class="wintitle"> rankad </span>, <span class="wintitle"> trended </span>, <span class="wintitle"> Retention </span>, <span class="wintitle"> tratt </span>, <span class="wintitle"> Geo Location </span> och <span class="wintitle"> Sunburst </span>-rapporter. (Allmän betaversion) </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Problemet med att vissa IMS-användare omdirigerade från [!DNL  marketing.adobe.com] kunde inte se några program i [!DNL  mobilemarketing.adobe.com] har åtgärdats.
...
<table id="table_1A8173DB38E8426D96BB7C57BF8FD2D5"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Med början i iOS SDK version 4.5 kan du med ett nytt iOS-tillägg samla in användningsdata från Apple Watch Apps, Today Widgets, Photo Editing widgets och alla andra iOS-tilläggsappar. </p> <p>Se <a href="https://docs.adobe.com/content/help/en/mobile-services/ios/ios-ext/ios-ext.html" format="https" scope="external"> iOS Extension Implementation </a> i guiden <a href="https://docs.adobe.com/content/help/en/mobile-services/ios/overview.html" format="https" scope="external"> iOS SDK 4.x för Marketing Cloud Solutions </a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> Android SDK version 4.5 </p> </td> 
   <td colname="col2"> <p>Från och med Android SDK version 4.5 kan du med ett nytt Android-tillägg samla in data från Android-appen som kan användas för läsning. </p> <p>Se <a href="https://docs.adobe.com/content/help/en/mobile-services/android/wearables-android/android-wearable.html" format="https" scope="external"> Android Wearable Implementation </a> i guiden <a href="https://docs.adobe.com/content/help/en/mobile-services/android/overview.html" format="https" scope="external"> Android SDK 4.x för Marketing Solutions </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Korrigerade ett problem med [!DNL  Target] kampanjrapporter som inte visas i rapporter och analyser.
* Ett problem med specialtecken i [!DNL  Target]-kampanjnamn som förhindrar rapportering i rapporter och analyser har korrigerats.
...
* Ett problem med [!UICONTROL Bots]-rapporter i kontrollpaneler som inte visade korrekta data har korrigerats.
* Ett problem med ikonen Redigera (penna) när du redigerade segment i Internet Explorer 11 har korrigerats. Detta problem tvingade dig att klicka på ikonen Redigera två gånger för att läsa in [!UICONTROL Segment Manager].
* Ett problem har korrigerats där ett felaktigt måttnamn och en felaktig valutaenhet visades i en [!UICONTROL Contribution Analysis]-rapport.
...
### AppMeasurement och Mobile SDK {#appmeasurement_sdk}
...
I [Versionshistorik för AppMeasurement](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html) nedan finns en versionshistorik för [!DNL  AppMeasurement] på följande plattformar:
...
<table id="table_3CA51E873E324FD4B7CF14190F127A77"> 
 ...
 <tbody> 
  <tr valign="top"> 
   <td colname="col1"> <p>Facebook mörka inlägg </p> </td> 
  ...
  <tr valign="top"> 
   <td colname="col1"> <p> <span class="keyword"> Adobe Social  </span> mobilapp </p> </td> 
   <td colname="col2"> <p><span class="keyword"> Adobe Social </span>-mobilappen för iOS kommer att vara tillgänglig i Apple App Store i juni 2015. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_191B769A5A8A405C87A34245BE6B1127"> 
 ...
 <tbody> 
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Välj en stillbild var som helst i videon som du vill överföra och använd som videons miniatyrbild i inlägget. Tidigare valde <span class="keyword"> Social </span> den inledande bildrutan som ska användas som miniatyrbild. 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Förbättrad metod <span class="keyword"> Social </span> som används för att hämta och visa bilder i Twitter direktmeddelanden i modereringsfeeds. 
     <!--AS-30675--></p> </td> 
  </tr> 
  <tr valign="top"> 
...
Denna [!DNL  Social]-release fokuserar på förbättrade prestanda, skalbarhet, användbarhet och tillförlitlighet. Mer än 140 snabbkorrigeringar och förbättringar åtgärdar dessa områden. De korrigeringar som markeras nedan beskriver lösningar på de viktigare kundrapporterade problemen.
...
* Ett problem som gjorde att spårningsparametrar inte kunde läggas till i inlägg som skapats med funktionen [!UICONTROL Publish Anywhere] har korrigerats.
  ...
  <tr> 
   ...
   <td colname="col2"> <p>I <span class="uicontrol"> Admin Tools </span> &gt; <span class="uicontrol"> Classification Rule Builder </span> &gt; <span class="term"> &amp;lt;rule set name&amp;gt; </span> två nya alternativ gör att du kan välja ett överskrivningsläge: </p> 
    <ul id="ul_14E61CC9E94B431090539CB47A9B83D6"> 
     ...
     <li id="li_0E82075DFBF04D1D8D686A5B95FCFB3E"> <b>Regler skriver bara över avaktiverade värden:</b> Fyll endast i tomma (urkopplade) celler. Befintliga klassificeringar ändras inte. </li> 
