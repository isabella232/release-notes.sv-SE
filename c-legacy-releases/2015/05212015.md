...
I [Versionshistorik för AppMeasurement](https://experienceleague.corp.adobe.com/docs/analytics/implementation/appmeasurement-updates.html) nedan finns en versionshistorik för [!DNL  AppMeasurement] på följande plattformar:
...
<table id="table_191B769A5A8A405C87A34245BE6B1127"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>Förbättrad metod <span class="keyword"> Social </span> som används för att hämta och visa bilder i Twitter-direktmeddelanden i modereringsflöden. 
     <!--AS-30675--></p> </td> 
  </tr> 
  <tr valign="top"> 
