---
description: Läs om nya funktioner och korrigeringar i Adobe Marketing Cloud.
keywords: release notes
seo-description: Läs om nya funktioner och korrigeringar i Adobe Marketing Cloud.
...
Läs om nya funktioner och korrigeringar i Adobe Marketing Cloud.
...
<table id="table_4ABE0F980A704B069BA9044E7F32ECFE"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <span class="wintitle"> Analytics </span> klassificeringsregler - skriv över befintliga värden </p> </td> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> Rapporterar <span class="wintitle"> Analytics </span> navigeringsuppdateringar </td> 
   <td colname="col2"> 
    <ul id="ul_156855264F144041A33CAB2D0B6D6F4D"> 
     ...
     <li id="li_C77D3CE4DF62476F9729519E153BA6E5"> 
      <!--AN-91912-->Rapportsvitens väljare finns nu i <span class="uicontrol"> Visa alla rapporter </span> i Rapporter och Analytics. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_9F4F40B4329443AC88F07B74660407C3"> 
     ...
     <li id="li_8EEB2C69113C43349F2B5E3AD9352B7B">Lagt till möjlighet att köra en uppsättning mätvärden utan att spara dem som standard. Detta är nu mer konsekvent med standardrapporter och Analytics-rapporter. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="wintitle"> Analytics </span> klassificeringsregler - skriv över befintliga värden </p> </td> 
   <td colname="col2"> <p>I <span class="uicontrol"> Analytics </span> &gt; <span class="uicontrol"> Admin </span> &gt; <span class="uicontrol"> Klassificeringsregelbyggaren </span> &gt; <span class="term"> &amp;lt;regeluppsättningens namn&amp;stämpel;gt; </span>kan du välja ett överskrivningsläge med två nya alternativ: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Obs!  </p> <p>1. Med hjälp av metrisk polaritet kan du ange om Adobe <span class="wintitle"> Analytics </span> ska se det som bra eller dåligt om en viss anpassad händelse (metrisk) inträffar. </p> <p>2. Då kan Adobe <span class="wintitle"> Analytics </span> visa riktningsvisare (pilar) för olika mätvärden för att lägga till kontext (t.ex. vecka över vecka-jämförelser). Exempel: Om "Bugs Suballowed" går upp i veckan över en vecka, skulle Adobe <span class="wintitle"> Analytics </span> tycka att det är bra eller dåligt? Andra exempel: En ökning av antalet e-postregistreringar är förmodligen bra. Men en ökning av antalet inskickningsfel i formulär är antagligen felaktig. </p> <p>I <span class="ignoretag"> Analytics <span class="uicontrol"> &gt; </span> Administratörsverktyg <span class="uicontrol"> &gt; </span> Redigera inställningar <span class="uicontrol"> &gt; </span> Konvertering <span class="uicontrol"> </span> <span class="uicontrol"> </span> </span><span class="uicontrol"> </span> &gt; Lyckade händelser¥, observerar du -kolumnen. Du kan kolla att <span class="uicontrol"> Up är bra </span> eller <span class="uicontrol"> Up är dåligt </span>. </p> </td> 
  </tr> 
 </tbody> 
</table>


### Marknadsföringsrapporter och Analytics {#fixes_reports_analytics}
...
Ändringarna gäller alla enhetliga segmenteringsfunktioner i Adobe [!DNL Analytics], inklusive rapportfunktionerna och Analytics- och Ad hoc-funktionerna.
...
I versionsinformationen [för](https://docs.adobe.com/content/help/en/target/using/release-notes/release-notes.html) Adobe Target finns information om de senaste datumen och releaserna.
